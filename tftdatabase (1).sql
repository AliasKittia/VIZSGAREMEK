...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2025 at 04:13 PM
...
CREATE TABLE `anomalies` (
  ...
  `AnomalyName` longtext NOT NULL,
  `AnomalyEffect` longtext NOT NULL
...
CREATE TABLE `augments` (
  ...
  `AugmentName` longtext NOT NULL,
  `AugmentRarity` longtext NOT NULL,
  `AugmentEffect` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `board` (
  ...
  `Boardname` longtext DEFAULT NULL,
...
--
-- Table structure for table `boardhexes`
--

CREATE TABLE `boardhexes` (
  `Id` int(11) NOT NULL,
  `Board_id` int(11) NOT NULL,
  `CharacterID` int(11) NOT NULL,
  `hex_x` int(11) NOT NULL,
  `hex_y` int(11) NOT NULL,
  `PostCharacterCharacterID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `character` (
  ...
  `AbilityName` longtext NOT NULL,
  `Ability` longtext NOT NULL,
  `Cost` int(11) NOT NULL,
  `Health` int(11) NOT NULL,
  `Health1` int(11) NOT NULL,
  `Health2` int(11) NOT NULL,
  `AttackSpeed` double NOT NULL,
  `Damage` int(11) NOT NULL,
  `Damage1` int(11) NOT NULL,
  `Damage2` int(11) NOT NULL,
  `AbilityPower` int(11) NOT NULL,
  `ManaStart` int(11) NOT NULL,
  `ManaMax` int(11) NOT NULL,
  `Armor` int(11) NOT NULL,
  `MagicResist` int(11) NOT NULL,
  `Range` int(11) NOT NULL,
  `Characterimageblob` longtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Amumu', 'Elavult technológia', 'Passzív: Csökkenti az összes bejövő sebzést 12-vel. Minden másodpercben szikrák keletkeznek, amelyek 10 AP varázssebzést okoznak a szomszédos ellenségeknek.', 1, 600, 1080, 1944, 0.6, 45, 81, 146, 100, 0, 0, 35, 35, 1, 'http://images.tftproject.nhely.hu/Characters/Amumu.png'),
(2, 'Darius', 'Tizedel', 'Forgás, fizikai sebzést okozva a szomszédos ellenségeknek és gyógyítva az életerőt. Fizikai sebzést okozó vérzést alkalmaz a célponton 4 másodpercen keresztül.', 1, 600, 1080, 1944, 0.7, 55, 99, 178, 100, 30, 70, 40, 40, 1, 'http://images.tftproject.nhely.hu/Characters/Darius.png'),
(3, 'Vex', 'Közelgő Sötétség', 'Varázssebzést okoz a célnak, és létrehoz egy sötétség zónát körülötte egy mezőnyi sugárral. Rövid késleltetés után varázssebzést okoz az ellenségeknek, akik még mindig a zónában tartózkodnak.', 1, 450, 810, 1458, 0.7, 30, 54, 97, 100, 0, 60, 15, 15, 4, 'http://images.tftproject.nhely.hu/Characters/Vex.png'),
(4, 'Violet', '1-2-3 Kombó', 'Két alkalommal megszúrja a célt fizikai sebzéssel. Ezután felütéssel támadja, fizikai sebzést okozva, és rövid időre felrepíti őt.', 1, 650, 1170, 2106, 0.8, 50, 90, 162, 100, 20, 65, 40, 40, 1, 'http://images.tftproject.nhely.hu/Characters/Violet.png'),
(5, 'Zyra', 'Tüskés Gyökerek', 'Szőlőket küld a célpont felé, megütve őt és 1 másodpercre megkábítva, miközben varázssebzést okoz. Ezután kisebb szőlők keresnek két legközelebbi ellenséget, és varázssebzést okoznak nekik.', 1, 500, 900, 1620, 0.7, 30, 54, 97, 120, 10, 60, 20, 20, 4, 'http://images.tftproject.nhely.hu/Characters/Zyra.png'),
(6, 'Draven', 'Forgó Harapások', 'Passzív: Ha Dravennek van egy megerősített balta a kezében, az felválthatja a következő támadását, fizikai sebzést okozva. A megerősített balták visszatérnek Dravenhez, miután eltaláltak egy ellenséget. Aktív: Forgat egy megerősített baltát.', 1, 500, 900, 1620, 0.7, 55, 99, 178, 100, 30, 60, 15, 15, 4, 'http://images.tftproject.nhely.hu/Characters/Draven.png'),
(7, 'Irelia', 'Kihívó Tánc', 'Védelmi állásba lép, és pajzsot szerez, amely gyorsan elhalványul 3 másodperc alatt. Amikor a pajzs lejár, varázssebzést okoz, plusz 30%-át az elnyelt sebzésnek, az Irelia körüli és előtte lévő ellenségeknek.', 1, 700, 1260, 2268, 0.6, 45, 81, 146, 100, 30, 70, 40, 40, 1, 'http://images.tftproject.nhely.hu/Characters/Irelia.png'),
(8, 'Lux', 'Prizmatikus Pajzs', 'Pajzsot ad a legkevesebb aktuális életerővel rendelkező szövetségesnek. Lux következő támadása bónusz varázssebzést okoz.', 1, 500, 900, 1620, 0.7, 30, 54, 97, 100, 0, 50, 20, 20, 4, 'http://images.tftproject.nhely.hu/Characters/Lux.png'),
(9, 'Maddie', 'Kalapács Tűz', 'Lőj 6 lövést a legmesszebb lévő ellenség felé, amelyek fizikai sebzést okoznak az első ellenségnek, akit eltalálnak.', 1, 500, 900, 1620, 0.7, 50, 80, 162, 100, 20, 120, 15, 15, 4, 'http://images.tftproject.nhely.hu/Characters/Maddie.png'),
(10, 'Powder', 'Zűrös Játékfigura', 'Küldj egy majmot a legnagyobb ellenségcsoport felé, ami egy 2 mezőnyi sugárral robban fel a találatkor. Az eltalált ellenségek varázssebzést szenvednek, amely csökken a robbanás középpontjától való távolságuk függvényében. Sebezést és 1%-os égést alkalmaz minden eltalált ellenségre 5 másodpercig.', 1, 500, 900, 1620, 0.7, 35, 63, 113, 100, 40, 120, 15, 15, 4, 'http://images.tftproject.nhely.hu/Characters/Powder.png'),
(11, 'Singed', 'Veszélyes Mutációk', 'Növeli a tartósságot, és a legtöbb sebzést okozó szövetségesnek támadási sebességet biztosít, ami 4 másodperc alatt elhalványul.', 1, 650, 1170, 2106, 0.6, 55, 99, 178, 100, 0, 50, 40, 40, 1, 'http://images.tftproject.nhely.hu/Characters/Singed.png'),
(12, 'Steb', 'Terepi Orvostudomány', 'Passzív: Gyógyuláskor a két legközelebbi szövetségest gyógyítja a gyógyulás 25%-ával. Aktív: Gyógyít, és varázssebzést okoz a célnak.', 1, 650, 1170, 2106, 0.55, 55, 99, 178, 100, 30, 90, 45, 45, 1, 'http://images.tftproject.nhely.hu/Characters/Steb.png'),
(13, 'Trundle', 'Kétségbeesett Rágás', 'Gyógyítja az egészséget és megrágja a célt fizikai sebzéssel. Mindkét hatás akár 75%-kal megnövelhető Trundle hiányzó életereje alapján.', 1, 650, 1170, 2106, 0.65, 50, 90, 162, 100, 30, 90, 40, 40, 1, 'http://images.tftproject.nhely.hu/Characters/Trundle.png'),
(14, 'Morgana', 'Kínzó Lélek', 'Átkoz egy legközelebbi, nem átkozott ellenséget, varázssebzést okozva neki 10 másodperc alatt, és csökkenti rajta használt pajzsok hatékonyságát 50%-kal.', 1, 500, 900, 1620, 0.7, 30, 54, 97, 100, 0, 40, 20, 20, 4, 'http://images.tftproject.nhely.hu/Characters/Morgana.png'),
(15, 'Akali', 'Shuriken Flip', 'Aktív: Akali shurikent dob a célpontra, varázssebzést okozva, és megjelöli őket, hogy 4 másodpercig több sebzést szenvedjenek el. Ezután Akali elugrik a célponttól, majd egy rövid késleltetés után visszaugrik hozzájuk, és újabb varázssebzést okoz.', 2, 700, 1260, 2268, 0.75, 45, 81, 146, 100, 0, 60, 45, 45, 1, 'http://images.tftproject.nhely.hu/Characters/Akali.png'),
(16, 'Camille', 'Adaptív csapás', 'Aktív: Megrúgja a célpontot, [150 / 224 / 374] adaptív sebzést okozva. Visszatölti az okozott sebzés 33%-át.', 2, 700, 1260, 2268, 0.75, 50, 90, 162, 100, 0, 25, 45, 45, 1, 'http://images.tftproject.nhely.hu/Characters/Camille.png'),
(17, 'Nocturne', 'Túláradó pengék', '6 másodpercig a támadások a környező ellenségeket is vérzésre kényszerítik, amely fizikai sebzést okoz 1 másodpercig.', 2, 700, 1260, 2268, 0.75, 65, 117, 211, 100, 0, 40, 45, 45, 1, 'http://images.tftproject.nhely.hu/Characters/Nocturne.png'),
(18, 'Rell', 'Törő Ütés', 'Pajzsot kap 4 másodpercre. Lándzsával eltalálja az ellenségeket egy vonalban varázssebzéssel, és elrabolja az általuk viselt Páncélt és Varázsvédelmet.', 2, 800, 1440, 2592, 0.6, 60, 108, 194, 100, 40, 90, 45, 45, 1, 'http://images.tftproject.nhely.hu/Characters/Rell.png'),
(19, 'Renata', 'Hűségprogram', 'Lő egy pár rakétát a célpontra. Azokat az szövetségeseket, akiken áthaladnak, 3 másodpercre pajzshoz juttatja. Amikor ütköznek, varázssebzést okoznak a célpontnak és varázssebzést az érintett ellenségeknek.', 2, 600, 1080, 1944, 0.7, 35, 63, 113, 100, 20, 80, 20, 20, 4, 'http://images.tftproject.nhely.hu/Characters/Renata.png'),
(20, 'Sett', 'Fejtörő', 'Aktiváláskor az ellenfeleket mindkét oldalról magához húzza és összeszedi őket, mágikus sebzést okozva és megállítva őket. Ha csak egy ellenséget húz be, akkor a sebzés és a Stun időtartama 50%-kal nő.', 2, 850, 1530, 2754, 0.6, 60, 108, 194, 100, 50, 100, 50, 50, 1, 'http://images.tftproject.nhely.hu/Characters/Sett.png'),
(21, 'Tristana', 'Rajzolj egy Gyöngyöt', 'A karakter ágyúgolyót lő a célpontra, fizikai sebzést okozva. Ha a célpont meghal, az ágyúgolyó visszapattan a legközelebbi ellenségre, és okozza az extrasebzést. Amikor ez megtörténik, permanensen növeli a támadó sebzését egy bizonyos százalékával.', 2, 550, 990, 1782, 0.7, 40, 72, 130, 100, 20, 60, 20, 20, 4, 'http://images.tftproject.nhely.hu/Characters/Tristana.png'),
(22, 'Urgot', 'Korrosív Töltet', 'Lő egy robbanó töltetet, fizikai sebzést okozva a célpontnak és a szomszédos ellenségeknek. 20%-kal csökkenti az összes eltalált ellenség Páncélját 6 másodpercre. Kísérleti Bónusz: A harc kezdetekor és képesség használata után rohan a célponthoz, majd szerez maximális életerő pajzsot és támadási sebességet 5 másodpercre.', 2, 700, 1260, 2268, 0.7, 50, 90, 162, 100, 20, 70, 45, 45, 2, 'http://images.tftproject.nhely.hu/Characters/Urgot.png'),
(23, 'Vander', 'Alvilági kopó', 'Vander 2,5 másodpercre megáll a támadással, és megerősödik, miközben a következő támadása extra fizikai sebzést okoz. A megerősödés mértéke a csapatban lévő 1-es vagy 2-es költségű bajnokok számától függ.', 2, 800, 1440, 2592, 0.7, 50, 90, 162, 100, 0, 50, 45, 45, 1, 'http://images.tftproject.nhely.hu/Characters/Vander.png'),
(24, 'Vladimir', 'Transzfúzió', 'A karakter meggyógyítja és varázssebzést okoz a célpontnak.', 2, 800, 1440, 2592, 0.65, 45, 81, 146, 100, 65, 65, 45, 45, 1, 'http://images.tftproject.nhely.hu/Characters/Vladimir.png'),
(25, 'Zeri', 'Élő Akkumulátor', 'A karakter minden harmadik támadása egy szikrával helyettesítődik, amely fizikai sebzést okoz a célpontnak és 2 közeli ellenségnek.', 2, 600, 1080, 1944, 0.75, 45, 81, 146, 100, 3, 3, 20, 20, 4, 'http://images.tftproject.nhely.hu/Characters/Zeri.png'),
(26, 'Ziggs', 'Bombák Bombája', 'A karakter egy bombát dob a célpontra, varázssebzést okozva. 3 mini-bomba repül ki, és véletlenszerű ellenségeknek okoz varázssebzést.', 2, 600, 1080, 1944, 0.7, 35, 63, 113, 100, 15, 60, 20, 20, 4, 'http://images.tftproject.nhely.hu/Characters/Ziggs.png'),
(27, 'Leona', 'Napfogyatkozás', 'Aktiváláskor Leona 3 másodpercre megerősödik, és 50% szívósságra tesz szert. Ezután 115 varázssebzést okoz a szomszédos ellenfeleknek.', 2, 800, 1440, 2592, 0.6, 55, 99, 178, 0, 40, 80, 50, 50, 1, 'http://images.tftproject.nhely.hu/Characters/Leona.png'),
(28, 'Scar', 'Sumpsnipe Meglepetés', 'Bombákat dob a legközelebbi 3 ellenségre, Stun-olja őket 1,5 másodpercre, és varázssebzést okoz mindegyiknek. Gyógyítja a karakter életerejét.', 3, 800, 1440, 2592, 0.65, 50, 90, 162, 100, 80, 155, 50, 50, 1, 'http://images.tftproject.nhely.hu/Characters/Scar.png'),
(29, 'Smeech', 'Hulladék Heker', 'A karakter a legkevesebb tárggyal rendelkező ellenség felé ugrik 4 hexen belül. Háromszor csap, összesen fizikai sebzést okozva. Ha az ellenség meghal, ismét ugrik, de 30%-kal kevesebb sebzést okoz.', 3, 800, 1440, 2592, 0.8, 65, 117, 211, 100, 20, 80, 50, 50, 1, 'http://images.tftproject.nhely.hu/Characters/Smeech.png'),
(30, 'Swain', 'Démoni Felemelkedés', 'Elülső: Gyógyít és felemelkedik 6 másodpercre. Miközben felemelkedett, gyógyít és varázssebzést okoz a közeli ellenségeknek minden másodpercben. Ha egy ellenséget legyőz, a felemelkedés időtartama 2 másodperccel meghosszabbodik. Hátsó: 8 varjút küld a célpontra, amelyek varázssebzést okoznak. Mindegyik varjú egy közeli ellenséghez repül, és varázssebzést okoz.', 3, 650, 1170, 2106, 0.7, 40, 72, 130, 100, 20, 70, 25, 25, 1, 'http://images.tftproject.nhely.hu/Characters/Swain.png'),
(31, 'Twisted Fate', 'Vad Kártyák', 'Három kártyát dob különböző célpontokra. Kék Kártya: Visszaállítja az életerőt a legalacsonyabb életerővel rendelkező szövetségesnek. Piros Kártya: Varázssebzést okoz a legnagyobb ellenségkörben. Sárga Kártya: Varázssebzést okoz a célpontnak, és Stun-olja 1 másodpercre.', 3, 700, 1260, 2268, 0.7, 35, 63, 113, 100, 25, 75, 25, 25, 4, 'http://images.tftproject.nhely.hu/Characters/TwistedFate.png'),
(32, 'Blitzcrank', 'Statikus Mező', 'Passzív: Sérülés után a karakter a megnyelt sebzés 0,03%-át varázssebzés formájában visszaveri a célpontra. Aktív: 415/440/465 (AP) pajzsot nyer 4 másodpercre. Sokkolja a legközelebbi 3 ellenséget 40/60/100 (AP) varázssebzéssel és csökkenti a sebzésüket 0,1%-kal 4 másodpercre.', 3, 850, 1530, 2754, 0.65, 50, 90, 162, 100, 50, 100, 50, 50, 1, 'http://images.tftproject.nhely.hu/Characters/Blitzcrank.png'),
(33, 'Ezreal', 'Esszencia Áramlás', 'A karakter egy lövéssel célozza meg a jelenlegi célpontját, amely fizikai sebzést okoz minden ellenségnek 1 hexen belül. Ezután fizikai sebzést okoz a robbanás középpontjában lévő egységnek.', 3, 700, 1260, 2268, 0.75, 60, 108, 194, 100, 60, 60, 25, 25, 4, 'http://images.tftproject.nhely.hu/Characters/Ezreal.png'),
(34, 'Gangplank', 'Aratás a Lángokból', 'Elülső: Tisztítja az összes negatív hatást és gyógyítja a karakter életerejét. Vágás, amely fizikai sebzést okoz az ellenségeknek egy vonalban. Ha csak egy ellenség találkozik a támadással, a sebzés megduplázódik. Hátsó: Passzív: Miközben Mana-t nyer, 3 ragadós bombát dob el. Ha az ellenség, akire rátapadnak, meghal, átkerülnek egy másik közeli ellenségre. Aktív: Aktiváld a bombákat, hogy fizikai sebzést okozzanak az ellenségnek, akire rátapadtak, és fizikai sebzést az összes közeli ellenségnek.', 3, 700, 1260, 2268, 0.7, 50, 90, 162, 100, 75, 75, 20, 20, 1, 'http://images.tftproject.nhely.hu/Characters/Gangplank.png'),
(35, 'Kogmaw', 'Fokozó Lőmód', 'Passzív: A támadások bónusz varázssebzést okoznak. Aktív: 25%-os, felhalmozódó támadási sebességet szerzel a harc hátralévő részére. Minden 3 használat után +1 hatótávot nyersz.', 3, 650, 1170, 2106, 0.7, 15, 27, 49, 100, 40, 40, 25, 25, 4, 'http://images.tftproject.nhely.hu/Characters/Kogmaw.png'),
(36, 'Loris', 'Piltover Pajzs', 'A karakter pajzsot kap 4 másodpercre. A pajzs 50%-át az őt körülvevő szövetségesek által elszenvedett sebzésnek átirányítja. Amikor a pajzs lejár, varázssebzést okoz egy kúpszerű területen.', 3, 850, 1530, 2754, 0.65, 50, 90, 162, 100, 50, 100, 50, 50, 1, 'http://images.tftproject.nhely.hu/Characters/Loris.png'),
(37, 'Nami', 'Oceán Áramlás', 'Egy hullámot indít a célpont felé, amely háromszor visszapattan 3 hexen belüli ellenségekre, varázssebzést okozva mindegyiknek.', 3, 700, 1260, 2268, 0.7, 40, 72, 130, 100, 60, 60, 25, 25, 4, 'http://images.tftproject.nhely.hu/Characters/Nami.png'),
(38, 'Nunu', 'ZOMBIE ERŐ!!', '3 másodpercre tartózkodj megnövelt ellenállással, és hozz létre egy 2 hex széles füstfelhőt, amely varázssebzést okoz az ellenségeknek. Ezután robbantsd fel a felhőt, és varázssebzést okozz az összes belső ellenségnek. Kísérleti Bónusz: Sebzés után 3%-os maximális életerő bónusz varázssebzést okozol (1 másodperces lehűlés).', 3, 800, 1440, 2592, 0.6, 50, 90, 162, 100, 60, 125, 50, 50, 1, 'http://images.tftproject.nhely.hu/Characters/Nunu.png'),
(39, 'Renni', 'Sludgerunner Ütés', 'A karakter 1,5 másodperc alatt gyógyítja meg magát. A képesség alatt felemeli a célpontot a levegőbe, Stun-olja és fizikai sebzést okoz. Ezután lecsapja a földre, fizikai sebzést okozva minden közeli ellenségnek.', 3, 850, 1530, 2754, 0.65, 55, 99, 178, 100, 40, 100, 50, 50, 1, 'http://images.tftproject.nhely.hu/Characters/Renni.png'),
(40, 'Cassiopeia', 'Tövises Miasma', 'A karakter varázssebzést okoz a célpontnak. Minden harmadik használatkor a miasma két ellenségre szóródik a 3 hexen belül, varázssebzést okozva mindegyiknek.', 3, 700, 1260, 2268, 0.7, 40, 72, 130, 100, 10, 40, 25, 25, 4, 'http://images.tftproject.nhely.hu/Characters/Cassiopeia.png'),
(41, 'Ekko', 'Másodpercek Felosztása', 'Elő hív egy utóképeket támadó hullámot, amely varázssebzést okoz a célpontnak és más közeli ellenségeknek. Az utóképek csökkentik a célpont varázsellenállását 5-tel a harc hátralévő részére.', 4, 1100, 1980, 3564, 0.85, 50, 90, 162, 100, 0, 60, 60, 60, 1, 'http://images.tftproject.nhely.hu/Characters/Ekko.png'),
(42, 'Elise', 'Kóma', 'Előre: Ugorj egy közeli hexára, és webeld be az összes ellenséget 2 hexen belül, Stun-olva őket és varázssebzést okozva. Gyógyítsd meg az életerőt. Hátra: Küldj pókcsemetéket a 4 legközelebbi ellenség felé, amelyek érintkezéskor felrobbannak, varázssebzést okozva a célpontnak és varázssebzést azok körül.', 4, 750, 1350, 2430, 0.75, 45, 81, 146, 100, 0, 10, 30, 30, 1, 'http://images.tftproject.nhely.hu/Characters/Elise.png'),
(43, 'Garen', 'Demaciai Igazság', 'Passzív: Sebzés okozása után gyógyulj meg. Aktív: Nyerd el a Páncélt 4 másodpercre. Csapj le egy hatalmas karddal a célpontra, fizikai sebzést okozva nekik, és fizikai sebzést okozva az 2 hexen belüli ellenségeknek.', 4, 1000, 1800, 3240, 0.6, 65, 117, 211, 100, 60, 125, 60, 60, 1, 'http://images.tftproject.nhely.hu/Characters/Garen.png'),
(44, 'Heimerdinger', 'PROGRESSSSS!', 'Lőj rakétákat véletlenszerű ellenségekre, amelyek varázssebzést okoznak. Minden egyes használatnál 1 rakéta több indul, mint az előző alkalommal.', 4, 800, 1440, 2592, 0.75, 40, 72, 130, 100, 0, 40, 30, 30, 4, 'http://images.tftproject.nhely.hu/Characters/Heimerdinger.png'),
(45, 'Illaoi', 'A Lélek Próbája', 'Nyerd el a Tartósságot 3 másodpercre. Az időtartam alatt elszívod az életerőt a legközelebbi ellenségektől. Ezt követően csapj le, varázssebzést okozva minden ellenségnek 2 hexen belül.', 4, 1100, 1980, 3564, 0.65, 70, 126, 227, 100, 65, 125, 60, 60, 1, 'http://images.tftproject.nhely.hu/Characters/Illaoi.png'),
(46, 'Dr.Mundo', 'Maximális Dózis', 'Aktiváld az energiát, és gyógyulj 2 másodperc alatt. Amíg energizált állapotban vagy, minden másodpercben varázssebzést okozol egy közeli ellenségnek. Ezt követően varázssebzést okozol minden ellenségnek 2 hexen belül. Kísérleti Bónusz: 120 maximális életerőt kapsz. Ha egy ellenséget legyőzöl, 60 maximális életerőt nyersz a harc hátralévő részére.', 4, 1100, 1980, 3564, 0.65, 60, 108, 194, 100, 30, 100, 60, 60, 1, 'http://images.tftproject.nhely.hu/Characters/DrMundo.png'),
(47, 'Silco', 'Konzerv Szörnyeteg', 'Hajíts egy kannát a célpontra, amely varázssebzést okoz és szörnyetegeket szabadít el. A szörnyetegek 5 alkalommal támadnak, minden támadás varázssebzést okoz.', 4, 800, 1440, 2592, 0.75, 40, 72, 130, 100, 30, 80, 30, 30, 4, 'http://images.tftproject.nhely.hu/Characters/Silco.png'),
(48, 'Twitch', 'Fújj és Imádkozz', 'Az elkövetkező 8 támadásnál szerez +85% támadási sebességet, végtelen hatótávolságot, és le cserélo a támadásokat egy áthatoló nyílra, amely véletlenszerű ellenségeket céloz. A nyilak fizikai sebzést okoznak, csökkentve azt minden ellenségen, amin áthaladnak. Kísérleti Bónusz: Minden 5. támadás után fizikai sebzést okozol a legközelebbi ellenségnek, ami a maximális egészségük % -ának megfelelően.', 4, 800, 1440, 2592, 0.75, 50, 90, 162, 100, 60, 60, 30, 30, 4, 'http://images.tftproject.nhely.hu/Characters/Twitch.png'),
(49, 'Vi', 'Zúzó Csapat', 'Nyerd el a Pajzsot 3 másodpercre, majd Stunold meg a célt 1,5 másodpercre. Csapd le őket, fizikai sebzést okozva, és egy sokkhullámot keltve a sorukban. Az ellenségek fizikai sebzést kapnak és rövid időre felrepülnek.', 4, 1100, 1980, 3564, 0.85, 75, 135, 243, 100, 40, 100, 50, 50, 1, 'http://images.tftproject.nhely.hu/Characters/Vi.png'),
(50, 'Zoe', 'Csillag Pörgetés!', 'Lőj egy csillagot a célpontra, amely varázssebzést okoz. Az visszapattan a legmesszebb lévő ellenséghez 4 hexen belül, majd visszapattan a célponthoz. Ez a hatás ismétlődik, minden alkalommal egy másik ellenséget eltalálva.', 4, 800, 1440, 2592, 0.75, 40, 72, 130, 100, 20, 80, 30, 30, 4, 'http://images.tftproject.nhely.hu/Characters/Zoe.png'),
(51, 'Ambessa', 'Kíméletlen Vadásznő', 'Ambessa két állás között vált aktiváláskor: Láncok: +1 hatótávot nyersz. A támadások fizikai sebzést okoznak. Aktiváláskor dash-elsz a célponthoz, és félkörben csapsz, fizikai sebzést okozva az eltalált ellenségeknek. Ököl: Omnivampot kapsz, és kétszer olyan gyorsan támadsz. Aktiváláskor röviden Stun-olod a célpontot, majd a földhöz csapod, fizikai sebzést okozva, végül elugrasz.', 4, 1100, 1980, 3564, 0.8, 65, 117, 211, 100, 40, 100, 50, 50, 1, 'http://images.tftproject.nhely.hu/Characters/Ambessa.png'),
(52, 'Corki', 'Széles Oldali Lövöldözés', 'Célozz meg egy célpontot, majd egy közeli pozícióba mozogj, miközben rakétákat lősz, amelyek a célpont és minden ellenség között oszlanak el 2 hexen belül. Minden rakéta fizikai sebzést okoz, és csökkenti az ellenség páncélját 1-tel. Minden 7. rakéta fizikai sebzést okoz és 7-tel csökkenti a páncélt.', 4, 850, 1530, 2754, 0.75, 60, 108, 194, 100, 0, 60, 30, 30, 4, 'http://images.tftproject.nhely.hu/Characters/Corki.png'),
(53, 'LeBlanc', 'The Chains of Fate', 'Aktív: Az 5 legközelebbi ellenséget összeköti láncokkal 5 másodpercre, megosztott varázssebzést okozva közöttük. Amikor egyet sebzés ér, a sebzés egy része bónusz igaz sebzésként oszlik meg a többi között. LeBlanc következő 3 támadása bónusz varázssebzést okoz, amely 0,5%-kal növekszik minden ellenség után, akit az eredeti sebzés megöl.', 5, 900, 1620, 2916, 0.8, 50, 90, 162, 100, 45, 90, 40, 40, 4, 'http://images.tftproject.nhely.hu/Characters/Leblanc.png'),
(54, 'Malzahar', 'Call of the Machine', 'Aktív: Egy kaput idéz meg, amely egy 5 mezős vonalon halad át a célponton. Az eltalált ellenségek varázssebzést szenvednek el, és 20%-os Shred hatást kapnak 4 másodpercig. Malzahar 5 fertőzéshalmot terjeszt az eltalált ellenségek között. Fertőzés: Minden másodpercben varázssebzést okoz a harc hátralevő részében. Ez a hatás végtelenül halmozható. Amikor egy fertőzött célpont meghal, a halmokat a közeli ellenségekre terjeszti. Shred: Csökkenti a varázsellenállást.', 5, 950, 1710, 3078, 0.8, 45, 81, 146, 100, 45, 105, 40, 40, 4, 'http://images.tftproject.nhely.hu/Characters/Malzahar.png'),
(55, 'Mordekaiser', 'Vasszellem markolása', 'Aktív: Rövid időre 40%-kal növeli a tartósságot, és egy hatalmas karmot idéz meg, amely varázssebzést okoz a legtöbb ellenségnek egy vonalban. A négy legközelebbi ellenség 25%-kal több sebzést kap, és Mordekaiser felé húzódik. A következő tíz másodpercben 30% életlopást kap, megnövelt támadási hatótávot szerez, és minden támadása helyett egy csapást hajt végre, amely varázssebzést okoz a célpontnak, valamint további varázssebzést minden más ellenségnek két hex távolságon belül.', 5, 1200, 2160, 3888, 0.55, 75, 135, 243, 100, 40, 100, 70, 70, 1, 'http://images.tftproject.nhely.hu/Characters/Mordekaiser.png'),
(56, 'Rumble', 'Az Egyenlítő', 'Hívj le 5 rakétát a cél sorára, amelyek mindegyike varázssebzést okoz, Sebzést és 1%-os Égést alkalmaz az eltalált egységeken 5 másodpercig. Minden olyan rakéta esetén, amely nem talál el ellenséget, 20 Manát visszanyersz. Ha már csak 1 ellenség marad, akkor mind az összes rakétát rájuk lődd. Égetés: Az ellenfél maximális életerejének egy százalékát igaz sebzésként okozza másodpercenként. Sebzés: Csökkenti a kapott gyógyítást 33%-kal.', 5, 1200, 2160, 3888, 0.8, 60, 108, 194, 100, 40, 120, 70, 70, 1, 'http://images.tftproject.nhely.hu/Characters/Rumble.png'),
(57, 'Sevika', 'A Szerencse Próbája', 'Véletlenszerűen elhúzódik 1 a 3 varázslat közül, esély van Jackpot-ra! Lángszóró: Igaz sebzést okoz a célpontnak minden másodpercben a haláláig. Az őt körülvevő ellenségek 50%-kal kevesebb fizikai sebzést kapnak. Hosszú Ütés: Fizikai sebzést okoz a célpontnak, és eltaszítja őket. Ezután dash-el a célponthoz, és 1 hex körüli körben fizikai sebzést okoz. Rágás: Fizikai sebzést okoz a célpontnak. Ha az életereje 15%-nál kevesebb, végrehajtja őt, és újra elvégzi a legkevesebb életerővel rendelkező célpont számára 2 hex távolságra, 80%-os sebzéssel.', 5, 1200, 2160, 3888, 0.9, 80, 144, 259, 100, 0, 60, 60, 60, 1, 'http://images.tftproject.nhely.hu/Characters/Sevika.png'),
(58, 'Caitlyn', 'Légi Támadás', 'Vedd fel a mesterlövész pozíciót, és hívd be a léghajót, amely 5 másodpercig köröz a csatatéren, és 4 bombát dob egy véletlenszerű ellenséges csoport közé. A bombák fizikai sebzést okoznak egy egy-hexes körben. Mikor egy ellenség a Légi Támadás robbanásának epicentrumába kerül, csökkenti az Ő védelmét és varázsellenállását 20-mal, miközben egy lövéssel célba veszi őt, és fizikai sebzést okoz.', 5, 900, 1620, 2916, 0.55, 80, 144, 259, 100, 0, 50, 40, 40, 4, 'http://images.tftproject.nhely.hu/Characters/Caitlyn.png'),
(59, 'Jayce', 'Különleges Szállítmány', 'Passzív: Helyezzen el egy Hextech Forge-t. Aktiváláskor a legközelebbi 3 szövetséges pajzsot kap 4 másodpercre. Ha elpusztul, 100%-os életerővel újraéleszti. Aktív: Hívjon elő 2 Hexgate-et, és dobja be a célt az egyikbe, fizikai sebzést okozva, miközben visszaküldi őket az eredeti helyükre. A repülés közben a célpont minden ellenséget eltalál a pályán, fizikai sebzést okozva.', 5, 900, 1620, 2916, 0.8, 60, 108, 194, 100, 30, 80, 35, 35, 1, 'http://images.tftproject.nhely.hu/Characters/Jayce.png'),
(60, 'Jinx', 'Minden Elpusztítása', 'Aktív: Jinx váltogat a következő képességek között: Zap: Fizikai sebzést okoz az ellenségeknek egy vonalban, és 1,25 másodpercre megmerevíti őket. Flame Chompers: Fizikai sebzést okoz 3, 1 hex-es körben lévő ellenségnek. Death Rocket: Lőjön egy rakétát a tábla közepére, ami fizikai sebzést okoz MINDEN ellenségnek, a sebzés 10%-kal csökken minden egyes hex-távolság után, amely távolabb van az epicentrumtól.', 5, 900, 1620, 2916, 0.8, 60, 108, 194, 100, 0, 60, 40, 40, 4, 'http://images.tftproject.nhely.hu/Characters/Jinx.png'),
(61, 'Mel', 'Mágia Csatorna', 'Mel teleportál egy közeli szövetségeshez vagy egy kiválasztott pontra a pályán, pajzsot biztosítva magának és a közeli szövetségeseinek, amely elnyeli a sebzést. A pajzsok által blokkolt sebzés energiává alakul, és ha Mel többször is használja a képességét, az energiát mágikus sebzéssé alakítja.', 6, 800, 800, 1000, 0.7, 60, 60, 80, 0, 50, 100, 35, 35, 3, 'http://images.tftproject.nhely.hu/Characters/Mel.png'),
(62, 'Viktor', 'Kaosz Vihar', 'Viktor egy hatalmas vihart szabadít el, amely egy vonalban sebzi az ellenségeket, miközben csökkenti azok páncélját és varázsellenállását. A képesség többször is aktiválható, minden alkalommal nagyobb sebzést okozva.', 6, 900, 900, 1100, 0.65, 75, 75, 95, 0, 60, 120, 40, 40, 3, 'http://images.tftproject.nhely.hu/Characters/Viktor.png'),
(63, 'Warwick', 'Vérvadászat', 'Warwick az alacsony egészségű ellenséget vadászza le, és jelentős bónusz sebzést okoz. Miután Warwick öt ellenséget legyőzött, bónusz támadási sebességet, életvisszanyerést és sebzéscsökkentést kap egy rövid időre.', 6, 850, 850, 1020, 0.75, 70, 70, 90, 0, 50, 100, 30, 30, 1, 'http://images.tftproject.nhely.hu/Characters/Warwick.png');
...
CREATE TABLE `class` (
  ...
  `BasicEffect` longtext NOT NULL,
  `Classimageblob` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Akadémia', 'Az Akadémia három tárgyat szponzorál minden játékban. A szponzorált tárgyak másolatai bónusz maximális életerőt és sebzésfokozást biztosítanak. Az Akadémia egységei, akik szponzorált tárgyakat tartanak, kétszeres bónuszt kapnak, plusz további 5% életerőt és sebzésfokozást.', 'http://images.tftproject.nhely.hu/Classes/Akadémia.png'),
(2, 'A gépek hírnöke', 'A gépek megnövelt erővel rendelkeznek, és bónusz életerőt és sebzést kapnak. A gépek emellett extra tartósságot nyernek páncél és varázsellenállás formájában, így ellenállóbbak az ellenséges támadásokkal szemben.', 'http://images.tftproject.nhely.hu/Classes/A%20gépek%20hírnöke.png'),
(3, 'Alakváltó', 'Az Alakváltók képesek átalakulni a csata során, lehetővé téve számukra, hogy formát változtassanak és fokozzák harci képességeiket. Alkalmazkodnak a helyzethez, és jelentős erőt nyernek, ahogy a harc folytatódik.', 'http://images.tftproject.nhely.hu/Classes/Alakváltó.png'),
(4, 'Automata', 'Az \"Automata\" effektusa szerint, amikor sebzést okoznak, kristályokat szereznek. Ha elérik a 20 kristályt, egy mágikus sebzést okozó robbanást idéznek elő a célpontjukon, amely tartalmazza a korábbi robbanás óta kapott sebzés 20%-át, miközben visszaállítják a kristályokat. Ezen kívül növelik a Páncélt és a Mágikus Ellenállást is.', 'http://images.tftproject.nhely.hu/Classes/Automata.png'),
(5, 'Barkácsoló', 'A Barkácsolók képesek összegyűjteni a csata során eldobott alkatrészeket. Ezek az alkatrészek fokozzák képességeiket, lehetővé téve számukra, hogy erőteljes tárgyakat építsenek és erősödjenek a játék előrehaladtával.', 'http://images.tftproject.nhely.hu/Classes/Barkácsoló.png'),
(6, 'Család', 'A Család egységei bónusz életerőt és támadási sebzést kapnak a családtagok számának megfelelően a táblán. Minél több családtag van jelen, annál erősebbek az effektek.', 'http://images.tftproject.nhely.hu/Classes/Család.png'),
(7, 'Egyeduralkodó', 'Az Egyeduralkodó egységei bónusz sebzést és életerőt kapnak, valamint képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat.', 'http://images.tftproject.nhely.hu/Classes/Egyeduralkodó.png'),
(8, 'Fekete rózsa', 'A Fekete rózsa egységei képesek elcsábítani az ellenséges egységeket, ideiglenesen átállítva őket a saját csapatukhoz, és így megerősítve a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Fekete%20rózsa.png'),
(9, 'Gladiátor', 'A Gladiátor egységei képesek megsemmisíteni az ellenséges egységeket, és a legyőzött ellenséges egységek után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Gladiátor.png'),
(10, 'Gyorstámadó', 'A Gyorstámadó egységei képesek gyorsan támadni, és minden támadásuk után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Gyorstámadó.png'),
(11, 'Hódító', 'A Hódító egységei képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat, és bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Hódító.png'),
(12, 'Kísérlet', 'A Kísérlet egységei képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat, és bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Kísérlet.png'),
(13, 'Követ', 'A Követ egységei képesek megsemmisíteni az ellenséges egységeket, és a legyőzött ellenséges egységek után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Követ.png'),
(14, 'Látnok', 'A Látnok egységei képesek gyorsan támadni, és minden támadásuk után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Látnok.png'),
(15, 'Lázadó', 'A Lázadó egységei képesek elcsábítani az ellenséges egységeket, ideiglenesen átállítva őket a saját csapatukhoz, és így megerősítve a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Lázadó.png'),
(16, 'Mesterlövész', 'A Mesterlövész egységei képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat, és bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Mesterlövész.png'),
(17, 'Nagy menő', 'A Nagy menő egységei képesek gyorsan támadni, és minden támadásuk után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Nagy%20menő.png'),
(18, 'Örző', 'Az Örző egységei képesek megsemmisíteni az ellenséges egységeket, és a legyőzött ellenséges egységek után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Örző.png'),
(19, 'Rajtaütő', 'A Rajtaütő egységei képesek elcsábítani az ellenséges egységeket, ideiglenesen átállítva őket a saját csapatukhoz, és így megerősítve a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Rajtaütő.png'),
(20, 'Roncskirály', 'A Roncskirály egységei képesek összegyűjteni a csata során eldobott alkatrészeket. Ezek az alkatrészek fokozzák képességeiket, lehetővé téve számukra, hogy erőteljes tárgyakat építsenek és erősödjenek a játék előrehaladtával.', 'http://images.tftproject.nhely.hu/Classes/Roncskirály.png'),
(21, 'Szikra', 'A Szikra egységei képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat, és bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Szikra.png'),
(22, 'Száműzött varázsló', 'A Száműzött varázslók képesek elcsábítani az ellenséges egységeket, ideiglenesen átállítva őket a saját csapatukhoz, és így megerősítve a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Száműzött%20varázsló.png'),
(23, 'Tüzér', 'A Tüzér egységei képesek gyorsan támadni, és minden támadásuk után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Tüzér.png'),
(24, 'Varázsló', 'A Varázsló egységei képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat, és bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Varázsló.png'),
(25, 'Vegybáró', 'A Vegybárók képesek összegyűjteni a csata során eldobott alkatrészeket. Ezek az alkatrészek fokozzák képességeiket, lehetővé téve számukra, hogy erőteljes tárgyakat építsenek és erősödjenek a játék előrehaladtával.', 'http://images.tftproject.nhely.hu/Classes/Vegybáró.png'),
(26, 'Végrehajtó', 'A Végrehajtó egységei képesek megsemmisíteni az ellenséges egységeket, és a legyőzött ellenséges egységek után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Végrehajtó.png'),
(27, 'Vérvadász', 'A Vérvadász egységei képesek gyorsan támadni, és minden támadásuk után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Vérvadász.png'),
(28, 'Virrasztó', 'A \"Virrasztó\" egységek megnövekedett Ellenállással rendelkeznek, amely tovább nő, ha több mint 50%-os életük van.', 'http://images.tftproject.nhely.hu/Classes/Virrasztó.png'),
(29, 'Zúzó', 'A Zúzó egységei képesek megsemmisíteni az ellenséges egységeket, és a legyőzött ellenséges egységek után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Zúzó.png');
...
CREATE TABLE `classlevelbonus` (
  ...
  `BonusEffect` longtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `fullitems` (
  ...
  `Halfitemeffect1` longtext NOT NULL,
  `Halfitemeffect2` longtext NOT NULL,
  `bonuseffect` longtext NOT NULL,
  `bonuseffect1` longtext NOT NULL,
  `bonuseffect2` longtext DEFAULT NULL,
  `ActiveEffect` longtext NOT NULL,
  `Fullitemimageblob` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Halál penge', '55% sebzés', '', '10% sebzésnövelés', '', NULL, '7% bónusz sebzést okoz.', 'http://images.tftproject.nhely.hu/fullitem/Hal%c3%a1l%20penge.png'),
(2, 'Hextech lőpenge', '20% sebzés', '20 varázserő', '15% életvarázs', '', NULL, 'A legalacsonyabb százalékos életerővel rendelkező szövetségest gyógyítja a kiosztott sebzés 20%-ával.', 'http://images.tftproject.nhely.hu/fullitem/Hextech%20l%c5%91penge.png'),
(3, 'Az éj kardja', '10% sebzés', '20 páncél', '20% varázsellenállás', '', NULL, 'Egyszer minden harc során: Ha az életerőd 60%-ra csökken, rövid időre célozhatatlanná válsz, és megszabadulsz a negatív hatásoktól. Ezt követően 15%-os bónusz támadási sebességet kapsz.', 'http://images.tftproject.nhely.hu/fullitem/Az%20%c3%a9j%20kardja.png'),
(4, 'Vérszomja', '15% sebzés', '20 varázsellenállás', '15 varázserő', '', NULL, '20% minden sebzésből gyógyítás. Egyszer minden harc során, ha az életerő 40%-ra csökken, egy 25%-os maximális életerőnyi pajzsot kap, amely legfeljebb 5 másodpercig tart. Minden sebzésből gyógyítás: A kiosztott sebzés egy részével gyógyítja magát.', 'http://images.tftproject.nhely.hu/fullitem/V%c3%a9rszomjas.png'),
(5, 'Sterak kihívása', '150 életerő', '10% sebzés', '', '', NULL, 'Egyszer minden harc során: Ha az életerőd 60%-ra csökken, 25%-kal megnő a maximális életerőd, és 35%-kal a sebzésed.', 'http://images.tftproject.nhely.hu/fullitem/Sterak%20kih%c3%adv%c3%a1sa.png'),
(6, 'Óriásölő', '25% sebzés', '25 varázserő', '10 támadási sebesség', '5% sebzésnövelés', NULL, '25%-kal több sebzést okoz az 1750-nél nagyobb maximális életerővel rendelkező ellenségeknek.', 'http://images.tftproject.nhely.hu/fullitem/%c3%93ri%c3%a1s%c3%b6l%c5%91.png'),
(7, 'Shojin Lándzsája', '15 mana', '15% sebzés', '15 varázserő', '', NULL, 'A támadások 5 bónusz Manát adnak.', 'http://images.tftproject.nhely.hu/fullitem/Shojin%20l%c3%a1ndzs%c3%a1ja.png'),
(8, 'Határtalan penge', '35% sebzés', '35% kritikus csapási esély', '', '', NULL, 'A képességek képesek kritikus csapást mérni. Ha a birtokos képességei már képesek kritikus csapásra, akkor 10% kritikus sebzés bónuszt kap helyette.', 'http://images.tftproject.nhely.hu/fullitem/Hat%c3%a1rtalan%20penge.png'),
(9, 'Koronaőr', '20 varázserő', '20 páncél', '100 életerő', '', NULL, 'Harc kezdetén: 30%-os maximális életerőnek megfelelő pajzsot kapsz 8 másodpercre. Amikor a pajzs lejár, 35 képességerőt kapsz.', 'http://images.tftproject.nhely.hu/fullitem/Korona%c5%91r.png'),
(10, 'Ionos szikra', '15 varázserő', '15 varázsellenállás', '150 életerő', '', NULL, '30%-kal csökkenti a varázsellenállást a 2 mezőn belüli ellenségeknél. Amikor az ellenségek képességet használnak, varázssebzést szenvednek el, amely a maximális manájuk 160%-ának felel meg. Gyengítés: Csökkenti a varázsellenállást.', 'http://images.tftproject.nhely.hu/fullitem/Ionos%20szikra.png'),
(11, 'Morellonomikon', '150 életerő', '25 varázserő', '10% támadási sebesség', '', NULL, 'A támadások és képességek 1%-kal égetik és 33%-kal sebezhetővé teszik az ellenségeket 10 másodpercre. [Egyedi – bajnokonként csak 1 lehet] Égetés: A célpont maximális életerejének egy százalékát valódi sebzésként okozza másodpercenként. Sebezhetőség: Csökkenti a kapott gyógyítást.', 'http://images.tftproject.nhely.hu/fullitem/Morellonomikon.png'),
(12, 'Guinsoo dühpengéje', '10 varázserő', '10% támadási sebesség', '', '', NULL, 'A támadások 5%-os halmozódó támadási sebességet biztosítanak.', 'http://images.tftproject.nhely.hu/fullitem/Guinsoo%20d%c3%bchpeng%c3%a9je.png'),
(13, 'Arkangyal pálcája', '15 mana', '20 varázserő', '', '', NULL, 'Harc kezdetén: Minden 5. másodpercben 30 képességerőt kapsz.', 'http://images.tftproject.nhely.hu/fullitem/Arkangyal%20p%c3%a1lc%c3%a1ja.png'),
(14, 'Drágaköves kesztyű', '35 varázserő', '35% kritikus csapási esély', '', '', NULL, 'Ha a viselő képességei már képesek kritikus csapást mérni, 10% kritikus sebzésbónuszt kap helyette.', 'http://images.tftproject.nhely.hu/fullitem/Dr%c3%a1gak%c3%b6ves%20keszty%c5%b1.png'),
(15, 'Rabadon halálsüvege', '50 varázserő', '15% támadási sebesség', '', '', NULL, '20% bónusz sebzést okoz.', 'http://images.tftproject.nhely.hu/fullitem/Rabadon%20hal%c3%a1ls%c3%bcvege.png'),
(16, 'A vízköpő sziklavértje', '30 varázsellenállás', '30 páncél', '150 életerő', '', NULL, 'Minden olyan ellenség után, aki a viselőt célozza, 10 páncélt és 10 varázsellenállást kapsz.', 'http://images.tftproject.nhely.hu/fullitem/A%20v%c3%adzk%c3%b6p%c5%91%20sziklav%c3%a9rtje.png'),
(17, 'Naptűz köpeny', '20 páncél', '150 életerő', '', '', NULL, 'Minden 2 másodpercben 1%-kal égeti és 33%-kal sebezhetővé teszi az ellenséget 2 mezőn belül 10 másodpercre. [Egyedi – bajnokonként csak 1 lehet] Égetés: A célpont maximális életerejének egy százalékát valódi sebzésként okozza másodpercenként. Sebezhetőség: Csökkenti a kapott gyógyítást.', 'http://images.tftproject.nhely.hu/fullitem/Napt%c5%b1z%20k%c3%b6peny.png'),
(18, 'A titán elszántsága', '20 páncél', '10% támadási sebesség', '', '', NULL, 'Minden támadás vagy sebzés után 2%-kal növekszik a támadási sebzésed és 1 képességerő, amely 25-ször halmozódhat. Teljes halmozódásnál 20 páncélt és 20 varázsellenállást kapsz.', 'http://images.tftproject.nhely.hu/fullitem/A%20tit%c3%a1n%20elsz%c3%a1nts%c3%a1ga.png'),
(19, 'Az oltalmazó esküje', '30 mana', '20 páncél', '', '', NULL, 'Minden harcban egyszer, 40% életerőnél, kapsz egy 25%-os maximális életerőnek megfelelő pajzsot, amely 5 másodpercig tart, és 20 páncélt, valamint 20 varázsellenállást kapsz.', 'http://images.tftproject.nhely.hu/fullitem/Az%20oltalmaz%c3%b3%20esk%c3%bcje.png'),
(20, 'Állhatatos szív', '20 páncél', '20% kritikus csapási esély', '200 életerő', '', NULL, '8%-kal kevesebb sebzést kapsz. Ha az életerőd 50% felett van, akkor 15%-kal kevesebb sebzést kapsz.', 'http://images.tftproject.nhely.hu/fullitem/%c3%81llhatatos%20sz%c3%adv.png'),
(21, 'Bokormellény', '65 páncél', '', '', '', NULL, 'Növekszik a maximális életerőd 5%-kal. 8%-kal kevesebb sebzést kapsz a támadásoktól. Amikor bármilyen támadás ér, 100 varázssebzést okozol az összes szomszédos ellenségnek. Késleltetés: 2 másodperc.', 'http://images.tftproject.nhely.hu/fullitem/Bokormell%c3%a9ny.png'),
(22, 'Egyenlepel', '150 életerő', '20 varázsellenállás', '', '', NULL, '30%-kal gyengíti a 2 mezőn belüli ellenségeket. Az első 10 másodpercben 25 páncélt és 25 varázsellenállást kapsz a harc során. Gyengítés: Csökkenti a páncélt.', 'http://images.tftproject.nhely.hu/fullitem/Egyenlepel.png'),
(23, 'Runaan hurrikánja', '20 varázsellenállás', '10% támadási sebesség', '25% sebzés', '', NULL, 'A támadások egy nyíllal lőnek a közeli ellenségre, amely a támadási sebzés 55%-át fizikai sebzésként okozza.', 'http://images.tftproject.nhely.hu/fullitem/Runaan%20hurrik%c3%a1nja.png'),
(24, 'Adaptív sisak', '20 varázsellenállás', '15 mana', '10 varázserő', '', NULL, 'Harc kezdetén: Különböző bónuszokat kapsz a kezdőpozíciótól függően. Elülső két sor: 40 páncélt és 40 varázsellenállást kapsz. 1 manát nyersz, amikor támadás ér. Hátsó két sor: 20 képességerőt kapsz. 10 manát nyersz minden 3 másodpercben.', 'http://images.tftproject.nhely.hu/fullitem/Adapt%c3%adv%20sisak.png'),
(25, 'Higany', '20 varázsellenállás', '20% kritikus csapási esély', '30% támadási sebesség', '', NULL, 'Harc kezdetén: 14 másodpercre immunitást kapsz a tömeges irányítású hatásokkal szemben. Ez idő alatt minden 2 másodpercben 4%-kal növekszik a támadási sebességed. [Egyedi – bajnokonként csak 1 lehet]', 'http://images.tftproject.nhely.hu/fullitem/Higany.png'),
(26, 'Sárkánykarom', '75 varázsellenállás', '', '', '', NULL, 'Növekszik a maximális életerőd 9%-kal. Minden 2 másodpercben 5%-kal gyógyítod a maximális életerődet.', 'http://images.tftproject.nhely.hu/fullitem/S%c3%a1rk%c3%a1nykarom.png'),
(27, 'Statikk töltőpengéje', '15% támadási sebesség', '15 mana', '15 varázserő', '', NULL, 'Minden 3. támadás 35 varázssebzést okoz, és 30%-kal gyengíti 4 ellenség varázsellenállását 5 másodpercre. Gyengítés: Csökkenti a varázsellenállást.', 'http://images.tftproject.nhely.hu/fullitem/Statikk%20t%c3%b6lt%c5%91peng%c3%a9je.png'),
(28, 'Utolsó lehelet', '20% támadási sebesség', '20% kritikus csapási esély', '15% sebzés', '', NULL, 'Fizikai sebzés: 30% meggyengíti a célpont páncélját 3 másodpercre. Ez a hatás nem halmozódik. [Egyedi – bajnokonként csak 1 lehet] Gyengítés: Csökkenti a páncélt.', 'http://images.tftproject.nhely.hu/fullitem/Utols%c3%b3%20lehelet.png'),
(29, 'Vörös erősítés', '35% támadási sebesség', '', '3% sebzésnövelés', '', NULL, '6% bónusz sebzést okoz. A támadások és képességek 1%-kal égetik és 33%-kal sebezhetővé teszik az ellenségeket 5 másodpercre. Égetés: A célpont maximális életerejének egy százalékát valódi sebzésként okozza másodpercenként. Sebezhetőség: Csökkenti a kapott gyógyítást.', 'http://images.tftproject.nhely.hu/fullitem/V%c3%b6r%c3%b6s%20er%c5%91s%c3%adt%c3%a9s.png'),
(30, 'Nashor foga', '150 életerő', '10% támadási sebesség', '10 varázserő', '', NULL, 'Képesség használata után 40%-kal növekszik a támadási sebességed 5 másodpercre.', 'http://images.tftproject.nhely.hu/fullitem/Nashor%20foga.png'),
(31, 'Megváltás', '150 életerő', '10 mana', '', '', NULL, 'Minden 5 másodpercben 15%-kal gyógyítja a 1 mezőn belüli szövetségeseket a hiányzó életerejükből. Ezen kívül 10%-kal kevesebb sebzést kapnak 5 másodpercre (a sebzéscsökkentés nem halmozódik). [Aura tárgy]', 'http://images.tftproject.nhely.hu/fullitem/Megv%c3%a1lt%c3%a1s.png'),
(32, 'Blokktörő', '150 életerő', '20% kritikus csapási esély', '10 varázserő', '20% támadási sebesség', ' 10% sebzésnövelés', 'Pajzs sebzése után 25%-kal több sebzést okozol 3 másodpercre.', 'http://images.tftproject.nhely.hu/fullitem/Blokkt%c3%b6r%c5%91.png'),
(33, 'Warmog vértje', '600 életerő', '', '', '', NULL, 'Növekszik a maximális életerőd 8%-kal.', 'http://images.tftproject.nhely.hu/fullitem/Warmog%20v%c3%a9rtje.png'),
(34, 'Kék erősítés', '30 mana', '', '15% sebzés', '15 varázserő', NULL, 'Amikor a viselő elér egy leütést, 8%-kal több sebzést okoz 8 másodpercre. [Egyedi – bajnokonként csak 1 lehet]', 'http://images.tftproject.nhely.hu/fullitem/K%c3%a9k%20er%c5%91s%c3%adt%c3%a9s.png'),
(35, 'Az igazság ökle', '15 mana', '20% kritikus csapási esély', '', '', NULL, 'Kapsz 2 hatást: • 15% támadási sebzést és 15 képességerőt. • 15% omnivámpír. Minden körben véletlenszerűen megkétszereződik az egyik hatás. Omnivámpír: A sebzés egy részét visszagyógyítja.', 'http://images.tftproject.nhely.hu/fullitem/Az%20igazs%c3%a1g%20%c3%b6kle.png'),
(36, 'Tolvajkesztyű', '20% kritikus csapási esély', '', '150 életerő', '', NULL, 'Minden körben: 2 véletlenszerű tárgyat kapsz. [3 tárgyhelyet fogyaszt.]', 'http://images.tftproject.nhely.hu/fullitem/Tolvajkeszty%c5%b1.png'),
(37, 'Taktikus köpenye', '', '', '', '', NULL, 'A csapatod +1 maximális csapatméretet kap. 10% eséllyel 1 aranyat kapsz, miután 10 másodpercig tartott a harc.', 'http://images.tftproject.nhely.hu/fullitem/Taktikus%20k%c3%b6penye.png'),
(38, 'A taktikus koronája', '', '', '', '', NULL, 'A csapatod +1 maximális csapatméretet kap. 10% eséllyel 1 aranyat kapsz, amikor megnyered a harcot.', 'http://images.tftproject.nhely.hu/fullitem/A%20taktikus%20koron%c3%a1ja.png'),
(39, 'Taktikus pajzsa', '', '', '', '', NULL, 'A csapatod +1 maximális csapatméretet kap. 10% eséllyel 1 aranyat kapsz, amikor a viselő meghal.', 'http://images.tftproject.nhely.hu/fullitem/Taktikus%20pajzsa.png');
...
CREATE TABLE `fullitems_partialitems` (
  ...
  `PostFullitemId` int(11) DEFAULT NULL,
  `PostFullitem_PartialitemId` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `fullitems_partialitems` (`Id`, `FullItemId`, `PartialItemId1`, `PartialItemId2`, `PostFullitemId`, `PostFullitem_PartialitemId`) VALUES
(1, 1, 1, 1, NULL, NULL),
(2, 2, 1, 2, NULL, NULL),
(3, 3, 1, 4, NULL, NULL),
(4, 4, 1, 5, NULL, NULL),
...
(35, 35, 8, 7, NULL, NULL),
(36, 36, 7, 7, NULL, NULL),
(37, 37, 9, 10, NULL, NULL),
(38, 38, 9, 9, NULL, NULL),
(39, 39, 10, 10, NULL, NULL);
...
CREATE TABLE `partialitems` (
  ...
  `halfitemimageBlob` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'K. N. Kard', '10 sebzés', 'http://images.tftproject.nhely.hu/halfitem/K.%20N.%20Kard.png'),
(2, 'Feleslegesen nagy pálca\r\n', '10 varázserő', 'http://images.tftproject.nhely.hu/halfitem/Feleslegesen%20nagy%20p%c3%a1lca.png'),
(3, 'Az óriás öve', '150 életerő', 'http://images.tftproject.nhely.hu/halfitem/Az%20%c3%b3ri%c3%a1s%20%c3%b6ve.png'),
(4, 'Sodronyozott mellény', '20 páncél', 'http://images.tftproject.nhely.hu/halfitem/Sodronyozott%20mell%c3%a9ny.png'),
(5, 'Negatron palást', '20 varázsellenállás', 'http://images.tftproject.nhely.hu/halfitem/Negatron%20pal%c3%a1st.png'),
(6, 'Reflexíj', '10% támadási sebesség', 'http://images.tftproject.nhely.hu/halfitem/Reflex%c3%adj.png'),
(7, 'Bokszkesztyűk', '5% kritikus csapási esély', 'http://images.tftproject.nhely.hu/halfitem/Bokszkeszty%c5%b1k.png'),
(8, 'Istennő könnycseppje', '15 mana', 'http://images.tftproject.nhely.hu/halfitem/Istenn%c5%91%20k%c3%b6nnycseppje.png'),
(9, 'Serpenyő', 'mi másért lenne itt', 'http://images.tftproject.nhely.hu/halfitem/Serpeny%c5%91.png'),
(10, 'Spatula', 'biztos csinál valamit', 'http://images.tftproject.nhely.hu/halfitem/Spatula.png');
...
INSERT INTO `permissions` (`Id`, `Level`, `Name`, `Description`) VALUES
...
CREATE TABLE `user` (
  ...
  `ProfilePicturePath` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(12, 'Em', 'f6921e96fff5b04e638a65ffeaea030b4b4da162824036ab443b2ad7424c6079', 'dyuBExqgN2wmmU068lp8VKTjnw71qSPn6v8YuvrjqGgLGBoLHvnlNz7pZpqe0eHV', 'Emil', 2, 2, 'Em@gmail.com', ''),
(13, 'Dani', 'f2f20f15c457ed586e0ad9d883e75bca152b11097596cf20a618060fab3b85ed', '1r6KXUaLwgJu4E9MqdgQ5hh16LvCtT5KgD8qHBl5oboY1X98YtZeJU8nZL1wZrkC', 'Dániel', 1, 1, 'dani@gmail.com', '');
...
('20250403091114_Mukodj', '8.0.0'),
('20250404081417_init', '8.0.0');
...
ALTER TABLE `board`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IX_Board_PostUserId` (`PostUserId`);

--
-- Indexes for table `boardhexes`
--
ALTER TABLE `boardhexes`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `IX_boardHexes_PostCharacterCharacterID` (`PostCharacterCharacterID`);
...
ALTER TABLE `fullitems_partialitems`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `IX_FullItems_PartialItems_PostFullitem_PartialitemId` (`PostFullitem_PartialitemId`),
  ADD KEY `IX_FullItems_PartialItems_PostFullitemId` (`PostFullitemId`);
...
ALTER TABLE `user`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `IX_User_PermissionId` (`PermissionId`);
...
--
-- AUTO_INCREMENT for table `boardhexes`
--
ALTER TABLE `boardhexes`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `character`
  MODIFY `CharacterID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `class`
--
ALTER TABLE `class`
  MODIFY `ClassId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `board`
  ADD CONSTRAINT `FK_Board_User_PostUserId` FOREIGN KEY (`PostUserId`) REFERENCES `user` (`Id`) ON DELETE CASCADE;

--
-- Constraints for table `boardhexes`
--
ALTER TABLE `boardhexes`
  ADD CONSTRAINT `FK_boardHexes_Character_PostCharacterCharacterID` FOREIGN KEY (`PostCharacterCharacterID`) REFERENCES `character` (`CharacterID`);
...
ALTER TABLE `characterclass`
  ...
  ADD CONSTRAINT `characterclass_ibfk_2` FOREIGN KEY (`ClassID`) REFERENCES `class` (`ClassId`) ON DELETE CASCADE;

--
-- Constraints for table `classlevelbonus`
--
ALTER TABLE `classlevelbonus`
  ADD CONSTRAINT `FK_Classlevelbonus_Class_ClassId` FOREIGN KEY (`ClassId`) REFERENCES `class` (`ClassId`) ON DELETE CASCADE;

--
-- Constraints for table `fullitems_partialitems`
--
ALTER TABLE `fullitems_partialitems`
  ADD CONSTRAINT `FK_FullItems_PartialItems_FullItems_PartialItems_PostFullitem_P~` FOREIGN KEY (`PostFullitem_PartialitemId`) REFERENCES `fullitems_partialitems` (`Id`),
  ADD CONSTRAINT `FK_FullItems_PartialItems_FullItems_PostFullitemId` FOREIGN KEY (`PostFullitemId`) REFERENCES `fullitems` (`Id`);

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `FK_User_Permissions_PermissionId` FOREIGN KEY (`PermissionId`) REFERENCES `permissions` (`Id`) ON DELETE CASCADE;
COMMIT;
