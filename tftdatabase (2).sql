...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2025 at 10:29 AM
...
CREATE TABLE `character` (
  ...
  `CharacterImgLink` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
INSERT INTO `character` (`CharacterID`, `CharacterName`, `AbilityName`, `Ability`, `Cost`, `Health`, `Health1`, `Health2`, `AttackSpeed`, `Damage`, `Damage1`, `Damage2`, `AbilityPower`, `ManaStart`, `ManaMax`, `Armor`, `MagicResist`, `Range`, `CharacterImgLink`) VALUES
...
CREATE TABLE `class` (
  ...
  `ClassImgLink` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
INSERT INTO `class` (`ClassID`, `ClassName`, `BasicEffect`, `ClassImgLink`) VALUES
...
CREATE TABLE `fullitems` (
  ...
  `FullItemImgLink` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
INSERT INTO `fullitems` (`Id`, `Name`, `Halfitemeffect1`, `Halfitemeffect2`, `bonuseffect`, `bonuseffect1`, `bonuseffect2`, `ActiveEffect`, `FullItemImgLink`) VALUES
...
CREATE TABLE `partialitems` (
  ...
  `HalfItemImgLink` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
INSERT INTO `partialitems` (`partial_item_id`, `name`, `effect`, `HalfItemImgLink`) VALUES
