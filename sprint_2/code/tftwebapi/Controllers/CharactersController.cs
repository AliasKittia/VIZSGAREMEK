...
public class CharactersController : ControllerBase
{
    private static readonly List<PostCharacter> _characters = new List<PostCharacter>
    {
        ...
        new PostCharacter{
            Id = 3,
            Name = "Blitczrank",
            Picture = "/images/Blitzcrank.png",
            Cost = 3,
            Items = new List<string> {"Dragon's Claw","Gargoyle Stoneplate","Warmog's Armor"},
            Health = new List<int> {850, 1530, 2754},
            Mana = new List<int> { 20, 70},
            Armor = 50,
            MR = 50,
            DPS = new List<int> {36, 65, 117},
            Damage = new List<int> {60, 108, 194},
            AtkSpd = 0.6f,
            CritRate = 0.25f,
            Range = 1
        }
