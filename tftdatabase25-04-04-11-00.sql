...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Ápr 04. 10:59
...
--
-- Adatbázis: `tftdatabase`
--

-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `anomalies`
--
...
--
-- A tábla adatainak kiíratása `anomalies`
--
...
--
-- Tábla szerkezet ehhez a táblához `augments`
--
...
--
-- A tábla adatainak kiíratása `augments`
--
...
--
-- Tábla szerkezet ehhez a táblához `board_hexes`
--
...
CREATE TABLE `character` (
  ...
  `Characterimageblob` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
--
-- Tábla szerkezet ehhez a táblához `characterclass`
--
...
--
-- A tábla adatainak kiíratása `characterclass`
--
...
CREATE TABLE `class` (
  ...
  `Classimageblob` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
(1, 'Akadémia', 'Az Akadémia három tárgyat szponzorál minden játékban. A szponzorált tárgyak másolatai bónusz maximális életerőt és sebzésfokozást biztosítanak. Az Akadémia egységei, akik szponzorált tárgyakat tartanak, kétszeres bónuszt kapnak, plusz további 5% életerőt és sebzésfokozást.', 'http://images.tftproject.nhely.hu/Classes/Akad%c3%a9mia.png'),
(2, 'A gépek hírnöke', 'A gépek megnövelt erővel rendelkeznek, és bónusz életerőt és sebzést kapnak. A gépek emellett extra tartósságot nyernek páncél és varázsellenállás formájában, így ellenállóbbak az ellenséges támadásokkal szemben.', 'http://images.tftproject.nhely.hu/Classes/A%20g%c3%a9pek%20h%c3%adrn%c3%b6ke.png'),
(3, 'Alakváltó', 'Az Alakváltók képesek átalakulni a csata során, lehetővé téve számukra, hogy formát változtassanak és fokozzák harci képességeiket. Alkalmazkodnak a helyzethez, és jelentős erőt nyernek, ahogy a harc folytatódik.', 'http://images.tftproject.nhely.hu/Classes/Alakv%c3%a1lt%c3%b3.png'),
...
(5, 'Barkácsoló', 'A Barkácsolók képesek összegyűjteni a csata során eldobott alkatrészeket. Ezek az alkatrészek fokozzák képességeiket, lehetővé téve számukra, hogy erőteljes tárgyakat építsenek és erősödjenek a játék előrehaladtával.', 'http://images.tftproject.nhely.hu/Classes/Bark%c3%a1csol%c3%b3.png'),
(6, 'Család', 'A Család egységei bónusz életerőt és támadási sebzést kapnak a családtagok számának megfelelően a táblán. Minél több családtag van jelen, annál erősebbek az effektek.', 'http://images.tftproject.nhely.hu/Classes/Csal%c3%a1d.png'),
(7, 'Egyeduralkodó', 'Az Egyeduralkodó egységei bónusz sebzést és életerőt kapnak, valamint képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat.', 'http://images.tftproject.nhely.hu/Classes/Egyeduralkod%c3%b3.png'),
(8, 'Fekete rózsa', 'A Fekete rózsa egységei képesek elcsábítani az ellenséges egységeket, ideiglenesen átállítva őket a saját csapatukhoz, és így megerősítve a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Fekete%20r%c3%b3zsa.png'),
(9, 'Gladiátor', 'A Gladiátor egységei képesek megsemmisíteni az ellenséges egységeket, és a legyőzött ellenséges egységek után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Gladi%c3%a1tor.png'),
(10, 'Gyorstámadó', 'A Gyorstámadó egységei képesek gyorsan támadni, és minden támadásuk után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Gyorst%c3%a1mad%c3%b3.png'),
(11, 'Hódító', 'A Hódító egységei képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat, és bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/H%c3%b3d%c3%adt%c3%b3.png'),
(12, 'Kísérlet', 'A Kísérlet egységei képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat, és bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/K%c3%ads%c3%a9rlet.png'),
(13, 'Követ', 'A Követ egységei képesek megsemmisíteni az ellenséges egységeket, és a legyőzött ellenséges egységek után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/K%c3%b6vet.png'),
(14, 'Látnok', 'A Látnok egységei képesek gyorsan támadni, és minden támadásuk után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/L%c3%a1tnok.png'),
(15, 'Lázadó', 'A Lázadó egységei képesek elcsábítani az ellenséges egységeket, ideiglenesen átállítva őket a saját csapatukhoz, és így megerősítve a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/L%c3%a1zad%c3%b3.png'),
(16, 'Mesterlövész', 'A Mesterlövész egységei képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat, és bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Mesterl%c3%b6v%c3%a9sz.png'),
(17, 'Nagy menő', 'A Nagy menő egységei képesek gyorsan támadni, és minden támadásuk után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Nagy%20men%c5%91.png'),
(18, 'Örző', 'Az Örző egységei képesek megsemmisíteni az ellenséges egységeket, és a legyőzött ellenséges egységek után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/%c3%96rz%c5%91.png'),
(19, 'Rajtaütő', 'A Rajtaütő egységei képesek elcsábítani az ellenséges egységeket, ideiglenesen átállítva őket a saját csapatukhoz, és így megerősítve a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Rajta%c3%bct%c5%91.png'),
(20, 'Roncskirály', 'A Roncskirály egységei képesek összegyűjteni a csata során eldobott alkatrészeket. Ezek az alkatrészek fokozzák képességeiket, lehetővé téve számukra, hogy erőteljes tárgyakat építsenek és erősödjenek a játék előrehaladtával.', 'http://images.tftproject.nhely.hu/Classes/Roncskir%c3%a1ly.png'),
...
(22, 'Száműzött varázsló', 'A Száműzött varázslók képesek elcsábítani az ellenséges egységeket, ideiglenesen átállítva őket a saját csapatukhoz, és így megerősítve a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Sz%c3%a1m%c5%b1z%c3%b6tt%20var%c3%a1zsl%c3%b3.png'),
(23, 'Tüzér', 'A Tüzér egységei képesek gyorsan támadni, és minden támadásuk után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/T%c3%bcz%c3%a9r.png'),
(24, 'Varázsló', 'A Varázsló egységei képesek átvenni az ellenséges egységek képességeit, ideiglenesen megerősítve sajátjukat, és bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Var%c3%a1zsl%c3%b3.png'),
(25, 'Vegybáró', 'A Vegybárók képesek összegyűjteni a csata során eldobott alkatrészeket. Ezek az alkatrészek fokozzák képességeiket, lehetővé téve számukra, hogy erőteljes tárgyakat építsenek és erősödjenek a játék előrehaladtával.', 'http://images.tftproject.nhely.hu/Classes/Vegyb%c3%a1r%c3%b3.png'),
(26, 'Végrehajtó', 'A Végrehajtó egységei képesek megsemmisíteni az ellenséges egységeket, és a legyőzött ellenséges egységek után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/V%c3%a9grehajt%c3%b3.png'),
(27, 'Vérvadász', 'A Vérvadász egységei képesek gyorsan támadni, és minden támadásuk után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/V%c3%a9rvad%c3%a1sz.png'),
(28, 'Virrasztó', 'A \"Virrasztó\" egységek megnövekedett Ellenállással rendelkeznek, amely tovább nő, ha több mint 50%-os életük van.', 'http://images.tftproject.nhely.hu/Classes/Virraszt%c3%b3.png'),
(29, 'Zúzó', 'A Zúzó egységei képesek megsemmisíteni az ellenséges egységeket, és a legyőzött ellenséges egységek után bónusz sebzést és életerőt kapnak, fokozva a csapat erejét.', 'http://images.tftproject.nhely.hu/Classes/Z%c3%baz%c3%b3.png');

-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `classlevelbonus`
--
...
--
-- A tábla adatainak kiíratása `classlevelbonus`
--
...
--
-- Tábla szerkezet ehhez a táblához `fullitems`
--
...
CREATE TABLE `fullitems` (
  ...
  `Fullitemimageblob` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;

--
-- A tábla adatainak kiíratása `fullitems`
--
...
--
-- Tábla szerkezet ehhez a táblához `fullitems_partialitems`
--
...
--
-- A tábla adatainak kiíratása `fullitems_partialitems`
--
...
--
-- Tábla szerkezet ehhez a táblához `partialitems`
--
...
CREATE TABLE `partialitems` (
  ...
  `HalfItemimageblob` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;

--
-- A tábla adatainak kiíratása `partialitems`
--
...
--
-- A tábla indexei `anomalies`
--
ALTER TABLE `anomalies`
  ADD PRIMARY KEY (`AnomalyId`);

--
-- A tábla indexei `augments`
--
...
--
-- A tábla indexei `characterclass`
--
...
--
-- A tábla indexei `classlevelbonus`
--
ALTER TABLE `classlevelbonus`
  ADD PRIMARY KEY (`ClassID`,`Level`);

--
-- A tábla indexei `fullitems`
--
ALTER TABLE `fullitems`
  ADD PRIMARY KEY (`Id`);

--
-- A tábla indexei `fullitems_partialitems`
--
...
--
-- AUTO_INCREMENT a táblához `anomalies`
--
ALTER TABLE `anomalies`
  MODIFY `AnomalyId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT a táblához `augments`
--
ALTER TABLE `augments`
  MODIFY `AugmentId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=311;
...
--
-- AUTO_INCREMENT a táblához `board_hexes`
--
ALTER TABLE `board_hexes`
...
--
-- AUTO_INCREMENT a táblához `fullitems`
--
ALTER TABLE `fullitems`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT a táblához `fullitems_partialitems`
--
ALTER TABLE `fullitems_partialitems`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT a táblához `partialitems`
--
ALTER TABLE `partialitems`
...
--
-- Megkötések a táblához `board_hexes`
--
ALTER TABLE `board_hexes`
...
--
-- Megkötések a táblához `characterclass`
--
ALTER TABLE `characterclass`
