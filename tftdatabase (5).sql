...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2025 at 08:21 PM
...
(1, 'Amumu', 'Elavult technológia', 'Passzív: Csökkenti az összes bejövő sebzést 12-vel. Minden másodpercben szikrák keletkeznek, amelyek 10 AP varázssebzést okoznak a szomszédos ellenségeknek.', 1, 600, 1080, 1944, 0.6, 45, 81, 146, 100, 0, 0, 35, 35, 1),
(2, 'Darius', 'Tizedel', 'Forgás, fizikai sebzést okozva a szomszédos ellenségeknek és gyógyítva az életerőt. Fizikai sebzést okozó vérzést alkalmaz a célponton 4 másodpercen keresztül.', 1, 600, 1080, 1944, 0.7, 55, 99, 178, 100, 30, 70, 40, 40, 1),
...
INSERT INTO `fullitems` (`Id`, `Name`, `Halfitemeffect1`, `Halfitemeffect2`, `bonuseffect`, `bonuseffect1`, `bonuseffect2`, `ActiveEffect`) VALUES
(1, 'Halál penge', '55% sebzés', '', '10% sebzésnövelés', '', NULL, '7% bónusz sebzést okoz.'),
(2, 'Hextech lőpenge', '20% sebzés', '20 varázserő', '15% életvarázs', '', NULL, 'A legalacsonyabb százalékos életerővel rendelkező szövetségest gyógyítja a kiosztott sebzés 20%-ával.'),
(3, 'Az éj kardja', '10% sebzés', '20 páncél', '20% varázsellenállás', '', NULL, 'Egyszer minden harc során: Ha az életerőd 60%-ra csökken, rövid időre célozhatatlanná válsz, és megszabadulsz a negatív hatásoktól. Ezt követően 15%-os bónusz támadási sebességet kapsz.'),
(4, 'Vérszomja', '15% sebzés', '20 varázsellenállás', '15 varázserő', '', NULL, '20% minden sebzésből gyógyítás. Egyszer minden harc során, ha az életerő 40%-ra csökken, egy 25%-os maximális életerőnyi pajzsot kap, amely legfeljebb 5 másodpercig tart. Minden sebzésből gyógyítás: A kiosztott sebzés egy részével gyógyítja magát.'),
(5, 'Sterak kihívása', '150 életerő', '10% sebzés', '', '', NULL, 'Egyszer minden harc során: Ha az életerőd 60%-ra csökken, 25%-kal megnő a maximális életerőd, és 35%-kal a sebzésed.'),
(6, 'Óriásölő', '25% sebzés', '25 varázserő', '10 támadási sebesség', '5% sebzésnövelés', NULL, '25%-kal több sebzést okoz az 1750-nél nagyobb maximális életerővel rendelkező ellenségeknek.'),
(7, 'Shojin Lándzsája', '15 mana', '15% sebzés', '15 varázserő', '', NULL, 'A támadások 5 bónusz Manát adnak.'),
(8, 'Határtalan penge', '35% sebzés', '35% kritikus csapási esély', '', '', NULL, 'A képességek képesek kritikus csapást mérni. Ha a birtokos képességei már képesek kritikus csapásra, akkor 10% kritikus sebzés bónuszt kap helyette.'),
(9, 'Koronaőr', '20 varázserő', '20 páncél', '100 életerő', '', NULL, 'Harc kezdetén: 30%-os maximális életerőnek megfelelő pajzsot kapsz 8 másodpercre. Amikor a pajzs lejár, 35 képességerőt kapsz.'),
(10, 'Ionos szikra', '15 varázserő', '15 varázsellenállás', '150 életerő', '', NULL, '30%-kal csökkenti a varázsellenállást a 2 mezőn belüli ellenségeknél. Amikor az ellenségek képességet használnak, varázssebzést szenvednek el, amely a maximális manájuk 160%-ának felel meg. Gyengítés: Csökkenti a varázsellenállást.'),
(11, 'Morellonomikon', '150 életerő', '25 varázserő', '10% támadási sebesség', '', NULL, 'A támadások és képességek 1%-kal égetik és 33%-kal sebezhetővé teszik az ellenségeket 10 másodpercre. [Egyedi – bajnokonként csak 1 lehet] Égetés: A célpont maximális életerejének egy százalékát valódi sebzésként okozza másodpercenként. Sebezhetőség: Csökkenti a kapott gyógyítást.'),
(12, 'Guinsoo dühpengéje', '10 varázserő', '10% támadási sebesség', '', '', NULL, 'A támadások 5%-os halmozódó támadási sebességet biztosítanak.'),
(13, 'Arkangyal pálcája', '15 mana', '20 varázserő', '', '', NULL, 'Harc kezdetén: Minden 5. másodpercben 30 képességerőt kapsz.'),
(14, 'Drágaköves kesztyű', '35 varázserő', '35% kritikus csapási esély', '', '', NULL, 'Ha a viselő képességei már képesek kritikus csapást mérni, 10% kritikus sebzésbónuszt kap helyette.'),
(15, 'Rabadon halálsüvege', '50 varázserő', '15% támadási sebesség', '', '', NULL, '20% bónusz sebzést okoz.'),
(16, 'A vízköpő sziklavértje', '30 varázsellenállás', '30 páncél', '150 életerő', '', NULL, 'Minden olyan ellenség után, aki a viselőt célozza, 10 páncélt és 10 varázsellenállást kapsz.'),
...
(18, 'A titán elszántsága', '20 páncél', '10% támadási sebesség', '', '', NULL, 'Minden támadás vagy sebzés után 2%-kal növekszik a támadási sebzésed és 1 képességerő, amely 25-ször halmozódhat. Teljes halmozódásnál 20 páncélt és 20 varázsellenállást kapsz.'),
(19, 'Az oltalmazó esküje', '30 mana', '20 páncél', '', '', NULL, 'Minden harcban egyszer, 40% életerőnél, kapsz egy 25%-os maximális életerőnek megfelelő pajzsot, amely 5 másodpercig tart, és 20 páncélt, valamint 20 varázsellenállást kapsz.'),
(20, 'Állhatatos szív', '20 páncél', '20% kritikus csapási esély', '200 életerő', '', NULL, '8%-kal kevesebb sebzést kapsz. Ha az életerőd 50% felett van, akkor 15%-kal kevesebb sebzést kapsz.'),
(21, 'Bokormellény', '65 páncél', '', '', '', NULL, 'Növekszik a maximális életerőd 5%-kal. 8%-kal kevesebb sebzést kapsz a támadásoktól. Amikor bármilyen támadás ér, 100 varázssebzést okozol az összes szomszédos ellenségnek. Késleltetés: 2 másodperc.'),
(22, 'Egyenlepel', '150 életerő', '20 varázsellenállás', '', '', NULL, '30%-kal gyengíti a 2 mezőn belüli ellenségeket. Az első 10 másodpercben 25 páncélt és 25 varázsellenállást kapsz a harc során. Gyengítés: Csökkenti a páncélt.'),
(23, 'Runaan hurrikánja', '20 varázsellenállás', '10% támadási sebesség', '25% sebzés', '', NULL, 'A támadások egy nyíllal lőnek a közeli ellenségre, amely a támadási sebzés 55%-át fizikai sebzésként okozza.'),
(24, 'Adaptív sisak', '20 varázsellenállás', '15 mana', '10 varázserő', '', NULL, 'Harc kezdetén: Különböző bónuszokat kapsz a kezdőpozíciótól függően. Elülső két sor: 40 páncélt és 40 varázsellenállást kapsz. 1 manát nyersz, amikor támadás ér. Hátsó két sor: 20 képességerőt kapsz. 10 manát nyersz minden 3 másodpercben.'),
(25, 'Higany', '20 varázsellenállás', '20% kritikus csapási esély', '30% támadási sebesség', '', NULL, 'Harc kezdetén: 14 másodpercre immunitást kapsz a tömeges irányítású hatásokkal szemben. Ez idő alatt minden 2 másodpercben 4%-kal növekszik a támadási sebességed. [Egyedi – bajnokonként csak 1 lehet]'),
(26, 'Sárkánykarom', '75 varázsellenállás', '', '', '', NULL, 'Növekszik a maximális életerőd 9%-kal. Minden 2 másodpercben 5%-kal gyógyítod a maximális életerődet.'),
(27, 'Statikk töltőpengéje', '15% támadási sebesség', '15 mana', '15 varázserő', '', NULL, 'Minden 3. támadás 35 varázssebzést okoz, és 30%-kal gyengíti 4 ellenség varázsellenállását 5 másodpercre. Gyengítés: Csökkenti a varázsellenállást.'),
(28, 'Utolsó lehelet', '20% támadási sebesség', '20% kritikus csapási esély', '15% sebzés', '', NULL, 'Fizikai sebzés: 30% meggyengíti a célpont páncélját 3 másodpercre. Ez a hatás nem halmozódik. [Egyedi – bajnokonként csak 1 lehet] Gyengítés: Csökkenti a páncélt.'),
...
(30, 'Nashor foga', '150 életerő', '10% támadási sebesség', '10 varázserő', '', NULL, 'Képesség használata után 40%-kal növekszik a támadási sebességed 5 másodpercre.'),
(31, 'Megváltás', '150 életerő', '10 mana', '', '', NULL, 'Minden 5 másodpercben 15%-kal gyógyítja a 1 mezőn belüli szövetségeseket a hiányzó életerejükből. Ezen kívül 10%-kal kevesebb sebzést kapnak 5 másodpercre (a sebzéscsökkentés nem halmozódik). [Aura tárgy]'),
(32, 'Blokktörő', '150 életerő', '20% kritikus csapási esély', '10 varázserő', '20% támadási sebesség', ' 10% sebzésnövelés', 'Pajzs sebzése után 25%-kal több sebzést okozol 3 másodpercre.'),
(33, 'Warmog vértje', '600 életerő', '', '', '', NULL, 'Növekszik a maximális életerőd 8%-kal.'),
(34, 'Kék erősítés', '30 mana', '', '15% sebzés', '15 varázserő', NULL, 'Amikor a viselő elér egy leütést, 8%-kal több sebzést okoz 8 másodpercre. [Egyedi – bajnokonként csak 1 lehet]'),
(35, 'Az igazság ökle', '15 mana', '20% kritikus csapási esély', '', '', NULL, 'Kapsz 2 hatást: • 15% támadási sebzést és 15 képességerőt. • 15% omnivámpír. Minden körben véletlenszerűen megkétszereződik az egyik hatás. Omnivámpír: A sebzés egy részét visszagyógyítja.'),
(36, 'Tolvajkesztyű', '20% kritikus csapási esély', '', '150 életerő', '', NULL, 'Minden körben: 2 véletlenszerű tárgyat kapsz. [3 tárgyhelyet fogyaszt.]'),
(37, 'Taktikus köpenye', '', '', '', '', NULL, 'A csapatod +1 maximális csapatméretet kap. 10% eséllyel 1 aranyat kapsz, miután 10 másodpercig tartott a harc.'),
(38, 'A taktikus koronája', '', '', '', '', NULL, 'A csapatod +1 maximális csapatméretet kap. 10% eséllyel 1 aranyat kapsz, amikor megnyered a harcot.'),
(39, 'Taktikus pajzsa', '', '', '', '', NULL, 'A csapatod +1 maximális csapatméretet kap. 10% eséllyel 1 aranyat kapsz, amikor a viselő meghal.');
...
(1, 'K. N. Kard', '10 sebzés'),
(2, 'Feleslegesen nagy pálca\r\n', '10 varázserő'),
(3, 'Az óriás öve', '150 életerő'),
(4, 'Sodronyozott mellény', '20 páncél'),
(5, 'Negatron palást', '20 varázsellenállás'),
(6, 'Reflexíj', '10% támadási sebesség'),
(7, 'Bokszkesztyűk', '5% kritikus csapási esély'),
(8, 'Istennő könnycseppje', '15 mana'),
(9, 'Serpenyő', 'mi másért lenne itt'),
(10, 'Spatula', 'biztos csinál valamit');
