...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2025 at 02:08 PM
...
(1, 'Amumu', 'Elavult technológia', 'Passzív: Csökkenti az összes bejövő sebzést 12-vel. Minden másodpercben szikrák keletkeznek, amelyek 10 AP varázssebzést okoznak a szomszédos ellenségeknek.', 1, 600, 1080, 1944, 0.6, 45, 81, 146, 100, 0, 0, 35, 35, 1, '/Characters/Amumu'),
(2, 'Darius', 'Tizedel', 'Forgás, fizikai sebzést okozva a szomszédos ellenségeknek és gyógyítva az életerőt. Fizikai sebzést okozó vérzést alkalmaz a célponton 4 másodpercen keresztül.', 1, 600, 1080, 1944, 0.7, 55, 99, 178, 100, 30, 70, 40, 40, 1, '/Characters/Darius'),
(3, 'Vex', 'Közelgő Sötétség', 'Varázssebzést okoz a célnak, és létrehoz egy sötétség zónát körülötte egy mezőnyi sugárral. Rövid késleltetés után varázssebzést okoz az ellenségeknek, akik még mindig a zónában tartózkodnak.', 1, 450, 810, 1458, 0.7, 30, 54, 97, 100, 0, 60, 15, 15, 4, '/Characters/Vex'),
(4, 'Violet', '1-2-3 Kombó', 'Két alkalommal megszúrja a célt fizikai sebzéssel. Ezután felütéssel támadja, fizikai sebzést okozva, és rövid időre felrepíti őt.', 1, 650, 1170, 2106, 0.8, 50, 90, 162, 100, 20, 65, 40, 40, 1, '/Characters/Violet'),
(5, 'Zyra', 'Tüskés Gyökerek', 'Szőlőket küld a célpont felé, megütve őt és 1 másodpercre megkábítva, miközben varázssebzést okoz. Ezután kisebb szőlők keresnek két legközelebbi ellenséget, és varázssebzést okoznak nekik.', 1, 500, 900, 1620, 0.7, 30, 54, 97, 120, 10, 60, 20, 20, 4, '/Characters/Zyra'),
(6, 'Draven', 'Forgó Harapások', 'Passzív: Ha Dravennek van egy megerősített balta a kezében, az felválthatja a következő támadását, fizikai sebzést okozva. A megerősített balták visszatérnek Dravenhez, miután eltaláltak egy ellenséget. Aktív: Forgat egy megerősített baltát.', 1, 500, 900, 1620, 0.7, 55, 99, 178, 100, 30, 60, 15, 15, 4, '/Characters/Draven'),
(7, 'Irelia', 'Kihívó Tánc', 'Védelmi állásba lép, és pajzsot szerez, amely gyorsan elhalványul 3 másodperc alatt. Amikor a pajzs lejár, varázssebzést okoz, plusz 30%-át az elnyelt sebzésnek, az Irelia körüli és előtte lévő ellenségeknek.', 1, 700, 1260, 2268, 0.6, 45, 81, 146, 100, 30, 70, 40, 40, 1, '/Characters/Irelia'),
(8, 'Lux', 'Prizmatikus Pajzs', 'Pajzsot ad a legkevesebb aktuális életerővel rendelkező szövetségesnek. Lux következő támadása bónusz varázssebzést okoz.', 1, 500, 900, 1620, 0.7, 30, 54, 97, 100, 0, 50, 20, 20, 4, '/Characters/Lux'),
(9, 'Maddie', 'Kalapács Tűz', 'Lőj 6 lövést a legmesszebb lévő ellenség felé, amelyek fizikai sebzést okoznak az első ellenségnek, akit eltalálnak.', 1, 500, 900, 1620, 0.7, 50, 80, 162, 100, 20, 120, 15, 15, 4, '/Characters/Maddie'),
(10, 'Powder', 'Zűrös Játékfigura', 'Küldj egy majmot a legnagyobb ellenségcsoport felé, ami egy 2 mezőnyi sugárral robban fel a találatkor. Az eltalált ellenségek varázssebzést szenvednek, amely csökken a robbanás középpontjától való távolságuk függvényében. Sebezést és 1%-os égést alkalmaz minden eltalált ellenségre 5 másodpercig.', 1, 500, 900, 1620, 0.7, 35, 63, 113, 100, 40, 120, 15, 15, 4, '/Characters/Powder'),
(11, 'Singed', 'Veszélyes Mutációk', 'Növeli a tartósságot, és a legtöbb sebzést okozó szövetségesnek támadási sebességet biztosít, ami 4 másodperc alatt elhalványul.', 1, 650, 1170, 2106, 0.6, 55, 99, 178, 100, 0, 50, 40, 40, 1, '/Characters/Singed'),
(12, 'Steb', 'Terepi Orvostudomány', 'Passzív: Gyógyuláskor a két legközelebbi szövetségest gyógyítja a gyógyulás 25%-ával. Aktív: Gyógyít, és varázssebzést okoz a célnak.', 1, 650, 1170, 2106, 0.55, 55, 99, 178, 100, 30, 90, 45, 45, 1, '/Characters/Steb'),
(13, 'Trundle', 'Kétségbeesett Rágás', 'Gyógyítja az egészséget és megrágja a célt fizikai sebzéssel. Mindkét hatás akár 75%-kal megnövelhető Trundle hiányzó életereje alapján.', 1, 650, 1170, 2106, 0.65, 50, 90, 162, 100, 30, 90, 40, 40, 1, '/Characters/Trundle'),
(14, 'Morgana', 'Kínzó Lélek', 'Átkoz egy legközelebbi, nem átkozott ellenséget, varázssebzést okozva neki 10 másodperc alatt, és csökkenti rajta használt pajzsok hatékonyságát 50%-kal.', 1, 500, 900, 1620, 0.7, 30, 54, 97, 100, 0, 40, 20, 20, 4, '/Characters/Morgana'),
...
(16, 'Camille', 'Adaptív csapás', 'Aktív: Megrúgja a célpontot, [150 / 224 / 374] adaptív sebzést okozva. Visszatölti az okozott sebzés 33%-át.', 2, 700, 1260, 2268, 0.75, 50, 90, 162, 100, 0, 25, 45, 45, 1, '/Characters/Camille'),
(17, 'Nocturne', 'Túláradó pengék', '6 másodpercig a támadások a környező ellenségeket is vérzésre kényszerítik, amely fizikai sebzést okoz 1 másodpercig.', 2, 700, 1260, 2268, 0.75, 65, 117, 211, 100, 0, 40, 45, 45, 1, '/Characters/Nocturne'),
(18, 'Rell', 'Törő Ütés', 'Pajzsot kap 4 másodpercre. Lándzsával eltalálja az ellenségeket egy vonalban varázssebzéssel, és elrabolja az általuk viselt Páncélt és Varázsvédelmet.', 2, 800, 1440, 2592, 0.6, 60, 108, 194, 100, 40, 90, 45, 45, 1, '/Characters/Rell'),
(19, 'Renata', 'Hűségprogram', 'Lő egy pár rakétát a célpontra. Azokat az szövetségeseket, akiken áthaladnak, 3 másodpercre pajzshoz juttatja. Amikor ütköznek, varázssebzést okoznak a célpontnak és varázssebzést az érintett ellenségeknek.', 2, 600, 1080, 1944, 0.7, 35, 63, 113, 100, 20, 80, 20, 20, 4, '/Characters/Renata'),
(20, 'Sett', 'Fejtörő', 'Aktiváláskor az ellenfeleket mindkét oldalról magához húzza és összeszedi őket, mágikus sebzést okozva és megállítva őket. Ha csak egy ellenséget húz be, akkor a sebzés és a Stun időtartama 50%-kal nő.', 2, 850, 1530, 2754, 0.6, 60, 108, 194, 100, 50, 100, 50, 50, 1, '/Characters/Sett'),
(21, 'Tristana', 'Rajzolj egy Gyöngyöt', 'A karakter ágyúgolyót lő a célpontra, fizikai sebzést okozva. Ha a célpont meghal, az ágyúgolyó visszapattan a legközelebbi ellenségre, és okozza az extrasebzést. Amikor ez megtörténik, permanensen növeli a támadó sebzését egy bizonyos százalékával.', 2, 550, 990, 1782, 0.7, 40, 72, 130, 100, 20, 60, 20, 20, 4, '/Characters/Tristana'),
(22, 'Urgot', 'Korrosív Töltet', 'Lő egy robbanó töltetet, fizikai sebzést okozva a célpontnak és a szomszédos ellenségeknek. 20%-kal csökkenti az összes eltalált ellenség Páncélját 6 másodpercre. Kísérleti Bónusz: A harc kezdetekor és képesség használata után rohan a célponthoz, majd szerez maximális életerő pajzsot és támadási sebességet 5 másodpercre.', 2, 700, 1260, 2268, 0.7, 50, 90, 162, 100, 20, 70, 45, 45, 2, '/Characters/Urgot'),
(23, 'Vander', 'Alvilági kopó', 'Vander 2,5 másodpercre megáll a támadással, és megerősödik, miközben a következő támadása extra fizikai sebzést okoz. A megerősödés mértéke a csapatban lévő 1-es vagy 2-es költségű bajnokok számától függ.', 2, 800, 1440, 2592, 0.7, 50, 90, 162, 100, 0, 50, 45, 45, 1, '/Characters/Vander'),
(24, 'Vladimir', 'Transzfúzió', 'A karakter meggyógyítja és varázssebzést okoz a célpontnak.', 2, 800, 1440, 2592, 0.65, 45, 81, 146, 100, 65, 65, 45, 45, 1, '/Characters/Vladimir'),
(25, 'Zeri', 'Élő Akkumulátor', 'A karakter minden harmadik támadása egy szikrával helyettesítődik, amely fizikai sebzést okoz a célpontnak és 2 közeli ellenségnek.', 2, 600, 1080, 1944, 0.75, 45, 81, 146, 100, 3, 3, 20, 20, 4, '/Characters/Zeri'),
(26, 'Ziggs', 'Bombák Bombája', 'A karakter egy bombát dob a célpontra, varázssebzést okozva. 3 mini-bomba repül ki, és véletlenszerű ellenségeknek okoz varázssebzést.', 2, 600, 1080, 1944, 0.7, 35, 63, 113, 100, 15, 60, 20, 20, 4, '/Characters/Ziggs'),
(27, 'Leona', 'Napfogyatkozás', 'Aktiváláskor Leona 3 másodpercre megerősödik, és 50% szívósságra tesz szert. Ezután 115 varázssebzést okoz a szomszédos ellenfeleknek.', 2, 800, 1440, 2592, 0.6, 55, 99, 178, 0, 40, 80, 50, 50, 1, '/Characters/Leona'),
(28, 'Scar', 'Sumpsnipe Meglepetés', 'Bombákat dob a legközelebbi 3 ellenségre, Stun-olja őket 1,5 másodpercre, és varázssebzést okoz mindegyiknek. Gyógyítja a karakter életerejét.', 3, 800, 1440, 2592, 0.65, 50, 90, 162, 100, 80, 155, 50, 50, 1, '/Characters/Scar'),
(29, 'Smeech', 'Hulladék Heker', 'A karakter a legkevesebb tárggyal rendelkező ellenség felé ugrik 4 hexen belül. Háromszor csap, összesen fizikai sebzést okozva. Ha az ellenség meghal, ismét ugrik, de 30%-kal kevesebb sebzést okoz.', 3, 800, 1440, 2592, 0.8, 65, 117, 211, 100, 20, 80, 50, 50, 1, '/Characters/Smeech'),
(30, 'Swain', 'Démoni Felemelkedés', 'Elülső: Gyógyít és felemelkedik 6 másodpercre. Miközben felemelkedett, gyógyít és varázssebzést okoz a közeli ellenségeknek minden másodpercben. Ha egy ellenséget legyőz, a felemelkedés időtartama 2 másodperccel meghosszabbodik. Hátsó: 8 varjút küld a célpontra, amelyek varázssebzést okoznak. Mindegyik varjú egy közeli ellenséghez repül, és varázssebzést okoz.', 3, 650, 1170, 2106, 0.7, 40, 72, 130, 100, 20, 70, 25, 25, 1, '/Characters/Swain'),
(31, 'Twisted Fate', 'Vad Kártyák', 'Három kártyát dob különböző célpontokra. Kék Kártya: Visszaállítja az életerőt a legalacsonyabb életerővel rendelkező szövetségesnek. Piros Kártya: Varázssebzést okoz a legnagyobb ellenségkörben. Sárga Kártya: Varázssebzést okoz a célpontnak, és Stun-olja 1 másodpercre.', 3, 700, 1260, 2268, 0.7, 35, 63, 113, 100, 25, 75, 25, 25, 4, '/Characters/TwistedFate'),
(32, 'Blitzcrank', 'Statikus Mező', 'Passzív: Sérülés után a karakter a megnyelt sebzés 0,03%-át varázssebzés formájában visszaveri a célpontra. Aktív: 415/440/465 (AP) pajzsot nyer 4 másodpercre. Sokkolja a legközelebbi 3 ellenséget 40/60/100 (AP) varázssebzéssel és csökkenti a sebzésüket 0,1%-kal 4 másodpercre.', 3, 850, 1530, 2754, 0.65, 50, 90, 162, 100, 50, 100, 50, 50, 1, '/Characters/Blitzcrank'),
(33, 'Ezreal', 'Esszencia Áramlás', 'A karakter egy lövéssel célozza meg a jelenlegi célpontját, amely fizikai sebzést okoz minden ellenségnek 1 hexen belül. Ezután fizikai sebzést okoz a robbanás középpontjában lévő egységnek.', 3, 700, 1260, 2268, 0.75, 60, 108, 194, 100, 60, 60, 25, 25, 4, '/Characters/Ezreal'),
(34, 'Gangplank', 'Aratás a Lángokból', 'Elülső: Tisztítja az összes negatív hatást és gyógyítja a karakter életerejét. Vágás, amely fizikai sebzést okoz az ellenségeknek egy vonalban. Ha csak egy ellenség találkozik a támadással, a sebzés megduplázódik. Hátsó: Passzív: Miközben Mana-t nyer, 3 ragadós bombát dob el. Ha az ellenség, akire rátapadnak, meghal, átkerülnek egy másik közeli ellenségre. Aktív: Aktiváld a bombákat, hogy fizikai sebzést okozzanak az ellenségnek, akire rátapadtak, és fizikai sebzést az összes közeli ellenségnek.', 3, 700, 1260, 2268, 0.7, 50, 90, 162, 100, 75, 75, 20, 20, 1, '/Characters/Gangplank'),
(35, 'Kogmaw', 'Fokozó Lőmód', 'Passzív: A támadások bónusz varázssebzést okoznak. Aktív: 25%-os, felhalmozódó támadási sebességet szerzel a harc hátralévő részére. Minden 3 használat után +1 hatótávot nyersz.', 3, 650, 1170, 2106, 0.7, 15, 27, 49, 100, 40, 40, 25, 25, 4, '/Characters/Kogmaw'),
(36, 'Loris', 'Piltover Pajzs', 'A karakter pajzsot kap 4 másodpercre. A pajzs 50%-át az őt körülvevő szövetségesek által elszenvedett sebzésnek átirányítja. Amikor a pajzs lejár, varázssebzést okoz egy kúpszerű területen.', 3, 850, 1530, 2754, 0.65, 50, 90, 162, 100, 50, 100, 50, 50, 1, '/Characters/Loris'),
(37, 'Nami', 'Oceán Áramlás', 'Egy hullámot indít a célpont felé, amely háromszor visszapattan 3 hexen belüli ellenségekre, varázssebzést okozva mindegyiknek.', 3, 700, 1260, 2268, 0.7, 40, 72, 130, 100, 60, 60, 25, 25, 4, '/Characters/Nami'),
(38, 'Nunu', 'ZOMBIE ERŐ!!', '3 másodpercre tartózkodj megnövelt ellenállással, és hozz létre egy 2 hex széles füstfelhőt, amely varázssebzést okoz az ellenségeknek. Ezután robbantsd fel a felhőt, és varázssebzést okozz az összes belső ellenségnek. Kísérleti Bónusz: Sebzés után 3%-os maximális életerő bónusz varázssebzést okozol (1 másodperces lehűlés).', 3, 800, 1440, 2592, 0.6, 50, 90, 162, 100, 60, 125, 50, 50, 1, '/Characters/Nunu'),
(39, 'Renni', 'Sludgerunner Ütés', 'A karakter 1,5 másodperc alatt gyógyítja meg magát. A képesség alatt felemeli a célpontot a levegőbe, Stun-olja és fizikai sebzést okoz. Ezután lecsapja a földre, fizikai sebzést okozva minden közeli ellenségnek.', 3, 850, 1530, 2754, 0.65, 55, 99, 178, 100, 40, 100, 50, 50, 1, '/Characters/Renni'),
(40, 'Cassiopeia', 'Tövises Miasma', 'A karakter varázssebzést okoz a célpontnak. Minden harmadik használatkor a miasma két ellenségre szóródik a 3 hexen belül, varázssebzést okozva mindegyiknek.', 3, 700, 1260, 2268, 0.7, 40, 72, 130, 100, 10, 40, 25, 25, 4, '/Characters/Cassiopeia'),
(41, 'Ekko', 'Másodpercek Felosztása', 'Elő hív egy utóképeket támadó hullámot, amely varázssebzést okoz a célpontnak és más közeli ellenségeknek. Az utóképek csökkentik a célpont varázsellenállását 5-tel a harc hátralévő részére.', 4, 1100, 1980, 3564, 0.85, 50, 90, 162, 100, 0, 60, 60, 60, 1, '/Characters/Ekko'),
(42, 'Elise', 'Kóma', 'Előre: Ugorj egy közeli hexára, és webeld be az összes ellenséget 2 hexen belül, Stun-olva őket és varázssebzést okozva. Gyógyítsd meg az életerőt. Hátra: Küldj pókcsemetéket a 4 legközelebbi ellenség felé, amelyek érintkezéskor felrobbannak, varázssebzést okozva a célpontnak és varázssebzést azok körül.', 4, 750, 1350, 2430, 0.75, 45, 81, 146, 100, 0, 10, 30, 30, 1, '/Characters/Elise'),
(43, 'Garen', 'Demaciai Igazság', 'Passzív: Sebzés okozása után gyógyulj meg. Aktív: Nyerd el a Páncélt 4 másodpercre. Csapj le egy hatalmas karddal a célpontra, fizikai sebzést okozva nekik, és fizikai sebzést okozva az 2 hexen belüli ellenségeknek.', 4, 1000, 1800, 3240, 0.6, 65, 117, 211, 100, 60, 125, 60, 60, 1, '/Characters/Garen'),
(44, 'Heimerdinger', 'PROGRESSSSS!', 'Lőj rakétákat véletlenszerű ellenségekre, amelyek varázssebzést okoznak. Minden egyes használatnál 1 rakéta több indul, mint az előző alkalommal.', 4, 800, 1440, 2592, 0.75, 40, 72, 130, 100, 0, 40, 30, 30, 4, '/Characters/Heimerdinger'),
(45, 'Illaoi', 'A Lélek Próbája', 'Nyerd el a Tartósságot 3 másodpercre. Az időtartam alatt elszívod az életerőt a legközelebbi ellenségektől. Ezt követően csapj le, varázssebzést okozva minden ellenségnek 2 hexen belül.', 4, 1100, 1980, 3564, 0.65, 70, 126, 227, 100, 65, 125, 60, 60, 1, '/Characters/Illaoi'),
(46, 'Dr.Mundo', 'Maximális Dózis', 'Aktiváld az energiát, és gyógyulj 2 másodperc alatt. Amíg energizált állapotban vagy, minden másodpercben varázssebzést okozol egy közeli ellenségnek. Ezt követően varázssebzést okozol minden ellenségnek 2 hexen belül. Kísérleti Bónusz: 120 maximális életerőt kapsz. Ha egy ellenséget legyőzöl, 60 maximális életerőt nyersz a harc hátralévő részére.', 4, 1100, 1980, 3564, 0.65, 60, 108, 194, 100, 30, 100, 60, 60, 1, '/Characters/DrMundo'),
(47, 'Silco', 'Konzerv Szörnyeteg', 'Hajíts egy kannát a célpontra, amely varázssebzést okoz és szörnyetegeket szabadít el. A szörnyetegek 5 alkalommal támadnak, minden támadás varázssebzést okoz.', 4, 800, 1440, 2592, 0.75, 40, 72, 130, 100, 30, 80, 30, 30, 4, '/Characters/Silco'),
(48, 'Twitch', 'Fújj és Imádkozz', 'Az elkövetkező 8 támadásnál szerez +85% támadási sebességet, végtelen hatótávolságot, és le cserélo a támadásokat egy áthatoló nyílra, amely véletlenszerű ellenségeket céloz. A nyilak fizikai sebzést okoznak, csökkentve azt minden ellenségen, amin áthaladnak. Kísérleti Bónusz: Minden 5. támadás után fizikai sebzést okozol a legközelebbi ellenségnek, ami a maximális egészségük % -ának megfelelően.', 4, 800, 1440, 2592, 0.75, 50, 90, 162, 100, 60, 60, 30, 30, 4, '/Characters/Twitch'),
(49, 'Vi', 'Zúzó Csapat', 'Nyerd el a Pajzsot 3 másodpercre, majd Stunold meg a célt 1,5 másodpercre. Csapd le őket, fizikai sebzést okozva, és egy sokkhullámot keltve a sorukban. Az ellenségek fizikai sebzést kapnak és rövid időre felrepülnek.', 4, 1100, 1980, 3564, 0.85, 75, 135, 243, 100, 40, 100, 50, 50, 1, '/Characters/Vi'),
(50, 'Zoe', 'Csillag Pörgetés!', 'Lőj egy csillagot a célpontra, amely varázssebzést okoz. Az visszapattan a legmesszebb lévő ellenséghez 4 hexen belül, majd visszapattan a célponthoz. Ez a hatás ismétlődik, minden alkalommal egy másik ellenséget eltalálva.', 4, 800, 1440, 2592, 0.75, 40, 72, 130, 100, 20, 80, 30, 30, 4, '/Characters/Zoe'),
(51, 'Ambessa', 'Kíméletlen Vadásznő', 'Ambessa két állás között vált aktiváláskor: Láncok: +1 hatótávot nyersz. A támadások fizikai sebzést okoznak. Aktiváláskor dash-elsz a célponthoz, és félkörben csapsz, fizikai sebzést okozva az eltalált ellenségeknek. Ököl: Omnivampot kapsz, és kétszer olyan gyorsan támadsz. Aktiváláskor röviden Stun-olod a célpontot, majd a földhöz csapod, fizikai sebzést okozva, végül elugrasz.', 4, 1100, 1980, 3564, 0.8, 65, 117, 211, 100, 40, 100, 50, 50, 1, '/Characters/Ambessa'),
(52, 'Corki', 'Széles Oldali Lövöldözés', 'Célozz meg egy célpontot, majd egy közeli pozícióba mozogj, miközben rakétákat lősz, amelyek a célpont és minden ellenség között oszlanak el 2 hexen belül. Minden rakéta fizikai sebzést okoz, és csökkenti az ellenség páncélját 1-tel. Minden 7. rakéta fizikai sebzést okoz és 7-tel csökkenti a páncélt.', 4, 850, 1530, 2754, 0.75, 60, 108, 194, 100, 0, 60, 30, 30, 4, '/Characters/Corki'),
(53, 'LeBlanc', 'The Chains of Fate', 'Aktív: Az 5 legközelebbi ellenséget összeköti láncokkal 5 másodpercre, megosztott varázssebzést okozva közöttük. Amikor egyet sebzés ér, a sebzés egy része bónusz igaz sebzésként oszlik meg a többi között. LeBlanc következő 3 támadása bónusz varázssebzést okoz, amely 0,5%-kal növekszik minden ellenség után, akit az eredeti sebzés megöl.', 5, 900, 1620, 2916, 0.8, 50, 90, 162, 100, 45, 90, 40, 40, 4, '/Characters/Leblanc'),
(54, 'Malzahar', 'Call of the Machine', 'Aktív: Egy kaput idéz meg, amely egy 5 mezős vonalon halad át a célponton. Az eltalált ellenségek varázssebzést szenvednek el, és 20%-os Shred hatást kapnak 4 másodpercig. Malzahar 5 fertőzéshalmot terjeszt az eltalált ellenségek között. Fertőzés: Minden másodpercben varázssebzést okoz a harc hátralevő részében. Ez a hatás végtelenül halmozható. Amikor egy fertőzött célpont meghal, a halmokat a közeli ellenségekre terjeszti. Shred: Csökkenti a varázsellenállást.', 5, 950, 1710, 3078, 0.8, 45, 81, 146, 100, 45, 105, 40, 40, 4, '/Characters/Malzahar'),
(55, 'Mordekaiser', 'Vasszellem markolása', 'Aktív: Rövid időre 40%-kal növeli a tartósságot, és egy hatalmas karmot idéz meg, amely varázssebzést okoz a legtöbb ellenségnek egy vonalban. A négy legközelebbi ellenség 25%-kal több sebzést kap, és Mordekaiser felé húzódik. A következő tíz másodpercben 30% életlopást kap, megnövelt támadási hatótávot szerez, és minden támadása helyett egy csapást hajt végre, amely varázssebzést okoz a célpontnak, valamint további varázssebzést minden más ellenségnek két hex távolságon belül.', 5, 1200, 2160, 3888, 0.55, 75, 135, 243, 100, 40, 100, 70, 70, 1, '/Characters/Mordekaiser'),
(56, 'Rumble', 'Az Egyenlítő', 'Hívj le 5 rakétát a cél sorára, amelyek mindegyike varázssebzést okoz, Sebzést és 1%-os Égést alkalmaz az eltalált egységeken 5 másodpercig. Minden olyan rakéta esetén, amely nem talál el ellenséget, 20 Manát visszanyersz. Ha már csak 1 ellenség marad, akkor mind az összes rakétát rájuk lődd. Égetés: Az ellenfél maximális életerejének egy százalékát igaz sebzésként okozza másodpercenként. Sebzés: Csökkenti a kapott gyógyítást 33%-kal.', 5, 1200, 2160, 3888, 0.8, 60, 108, 194, 100, 40, 120, 70, 70, 1, '/Characters/Rumble'),
(57, 'Sevika', 'A Szerencse Próbája', 'Véletlenszerűen elhúzódik 1 a 3 varázslat közül, esély van Jackpot-ra! Lángszóró: Igaz sebzést okoz a célpontnak minden másodpercben a haláláig. Az őt körülvevő ellenségek 50%-kal kevesebb fizikai sebzést kapnak. Hosszú Ütés: Fizikai sebzést okoz a célpontnak, és eltaszítja őket. Ezután dash-el a célponthoz, és 1 hex körüli körben fizikai sebzést okoz. Rágás: Fizikai sebzést okoz a célpontnak. Ha az életereje 15%-nál kevesebb, végrehajtja őt, és újra elvégzi a legkevesebb életerővel rendelkező célpont számára 2 hex távolságra, 80%-os sebzéssel.', 5, 1200, 2160, 3888, 0.9, 80, 144, 259, 100, 0, 60, 60, 60, 1, '/Characters/Sevika'),
(58, 'Caitlyn', 'Légi Támadás', 'Vedd fel a mesterlövész pozíciót, és hívd be a léghajót, amely 5 másodpercig köröz a csatatéren, és 4 bombát dob egy véletlenszerű ellenséges csoport közé. A bombák fizikai sebzést okoznak egy egy-hexes körben. Mikor egy ellenség a Légi Támadás robbanásának epicentrumába kerül, csökkenti az Ő védelmét és varázsellenállását 20-mal, miközben egy lövéssel célba veszi őt, és fizikai sebzést okoz.', 5, 900, 1620, 2916, 0.55, 80, 144, 259, 100, 0, 50, 40, 40, 4, '/Characters/Caitlyn'),
(59, 'Jayce', 'Különleges Szállítmány', 'Passzív: Helyezzen el egy Hextech Forge-t. Aktiváláskor a legközelebbi 3 szövetséges pajzsot kap 4 másodpercre. Ha elpusztul, 100%-os életerővel újraéleszti. Aktív: Hívjon elő 2 Hexgate-et, és dobja be a célt az egyikbe, fizikai sebzést okozva, miközben visszaküldi őket az eredeti helyükre. A repülés közben a célpont minden ellenséget eltalál a pályán, fizikai sebzést okozva.', 5, 900, 1620, 2916, 0.8, 60, 108, 194, 100, 30, 80, 35, 35, 1, '/Characters/Jayce'),
(60, 'Jinx', 'Minden Elpusztítása', 'Aktív: Jinx váltogat a következő képességek között: Zap: Fizikai sebzést okoz az ellenségeknek egy vonalban, és 1,25 másodpercre megmerevíti őket. Flame Chompers: Fizikai sebzést okoz 3, 1 hex-es körben lévő ellenségnek. Death Rocket: Lőjön egy rakétát a tábla közepére, ami fizikai sebzést okoz MINDEN ellenségnek, a sebzés 10%-kal csökken minden egyes hex-távolság után, amely távolabb van az epicentrumtól.', 5, 900, 1620, 2916, 0.8, 60, 108, 194, 100, 0, 60, 40, 40, 4, '/Characters/Jinx'),
(61, 'Mel', 'Mágia Csatorna', 'Mel teleportál egy közeli szövetségeshez vagy egy kiválasztott pontra a pályán, pajzsot biztosítva magának és a közeli szövetségeseinek, amely elnyeli a sebzést. A pajzsok által blokkolt sebzés energiává alakul, és ha Mel többször is használja a képességét, az energiát mágikus sebzéssé alakítja.', 6, 800, 800, 1000, 0.7, 60, 60, 80, 0, 50, 100, 35, 35, 3, '/Characters/Mel'),
(62, 'Viktor', 'Kaosz Vihar', 'Viktor egy hatalmas vihart szabadít el, amely egy vonalban sebzi az ellenségeket, miközben csökkenti azok páncélját és varázsellenállását. A képesség többször is aktiválható, minden alkalommal nagyobb sebzést okozva.', 6, 900, 900, 1100, 0.65, 75, 75, 95, 0, 60, 120, 40, 40, 3, '/Characters/Viktor'),
(63, 'Warwick', 'Vérvadászat', 'Warwick az alacsony egészségű ellenséget vadászza le, és jelentős bónusz sebzést okoz. Miután Warwick öt ellenséget legyőzött, bónusz támadási sebességet, életvisszanyerést és sebzéscsökkentést kap egy rövid időre.', 6, 850, 850, 1020, 0.75, 70, 70, 90, 0, 50, 100, 30, 30, 1, '/Characters/Warwick');
